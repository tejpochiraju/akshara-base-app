Game.grade1Measurement=function(game){
	
};

Game.grade1Measurement.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade1NumberOperation");
		...
		grade1NumberSenseSelected = false;
		 ...
		 grade1MeasurementSelected = true;
		...
		_this.grade1additionQuantityGroup.x = 0;
		_this.grade1additionQuantityGroup.y = 0;

		_this.SubtractionWithQuantityGroup.x = 0;
		_this.SubtractionWithQuantityGroup.y = 250;

		_this.MultiplicationWithQuantityGroup.x = 0;
		_this.MultiplicationWithQuantityGroup.y = 500;

		_this.DivisionWithQuantityGroup.x = 0;
		_this.DivisionWithQuantityGroup.y = 750;
	...
	additionQuantityTopic:function()
	{
		...
		_this.hungryRabbit5_1ScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.hungryRabbit5_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.coinMachine7_1_1ScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.coinMachine7_1_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.coinMachine7_2_1Screen = _this.add.sprite(500,120,'unity7_2_1');
		...
		_this.coinMachine7_2_1ScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.coinMachine7_2_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.grade1additionQuantityGroup.add(_this.bgGraphic1);		
		...
		_this.grade1additionQuantityGroup.add(_this.bgGraphic2);
		...
		_this.grade1additionQuantityGroup.add(_this.bgGraphic3);
		...
		_this.grade1additionQuantityGroup.add(_this.bgGraphic4);
	...
	SubtractionWithQuantity:function()
	{
		...
		_this.hungryRabbit8_1ScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.hungryRabbit8_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.coinMachine10_1_1ScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.coinMachine10_1_1ScreenTxt.anchor.setTo(0.5);
				...
				if(_this.tap)
				{
					...
					if(window.languageSelected == "Gujarati")
					{
						...
						_this.time.events.add(500, function(){
							...
							_this.time.events.add(14500, function(){
		...
		_this.coinMachine10_2_1ScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.coinMachine10_2_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.SubtractionWithQuantityGroup.add(_this.bgGraphic1);
		...
		_this.SubtractionWithQuantityGroup.add(_this.bgGraphic2);
		...
		_this.SubtractionWithQuantityGroup.add(_this.bgGraphic3);
	...
	MultiplicationWithQuantity:function()
	{
		...
		_this.AforApple11_1ScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.AforApple11_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.AforApple11_2ScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.AforApple11_2ScreenTxt.anchor.setTo(0.5);
		...
		_this.multiplication12_3_1ScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.multiplication12_3_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.MultiplicationWithQuantityGroup.add(_this.bgGraphic1);
		...
		_this.MultiplicationWithQuantityGroup.add(_this.bgGraphic2);
		...
		_this.MultiplicationWithQuantityGroup.add(_this.bgGraphic3);
	...
	DivisionWithQuantity:function()
	{
		...
		_this.Division16_1ScreenTxt = this.add.text(425, 192, '2');
		...
		_this.Division16_2ScreenTxt = this.add.text(625, 192, '3');
	 ...
	 playDemoVideos:function(target){
        ...
        switch(target)
        {
            ...
            case '10_1_1a': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/English/Game 10.1.1a.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Hindi/Game 10.1.1a.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Kannada/Game 10.1.1a.mp3");
							}
							else if(window.languageSelected=="Gujarati")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Gujarati/10.1.1a.mp3");
							}
							else
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Odiya/10.1.1a.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
			case '10_1_1b': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/English/Game 10.1.1b.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Hindi/Game 10.1.1b.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Kannada/Game 10.1.1b.mp3");
							}
							else if(window.languageSelected=="Gujarati")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Gujarati/10.1.1b.mp3");
							}
							else
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Odiya/10.1.1b.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
			case '10_1_1c': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/English/Game 10.1.1c.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Hindi/Game 10.1.1c.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Kannada/Game 10.1.1c.mp3");
							}
							else if(window.languageSelected=="Gujarati")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Gujarati/10.1.1c.mp3");
							}
							else
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Odiya/10.1.1c.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
