Game.grade1NumberSense=function(game){
	
};

Game.grade1NumberSense.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade1NumberScene");
		...
		grade1ShapesSenseSelected = false;
		 ...
		 grade1NumberSenseSelected = true;
		...
		_this.grade1QuantityNumeralGroup.x = 0;
		_this.grade1QuantityNumeralGroup.y = 0;

		_this.sequenceGroup.x = 0;
		_this.sequenceGroup.y = 450;

		_this.ComparisionOfNumbersGroup.x = 0;
		_this.ComparisionOfNumbersGroup.y = 1100;

		_this.PlaceValueGroup.x = 0;
		_this.PlaceValueGroup.y = 1550;

		_this.grade1FractionGroup.x = 0;
		_this.grade1FractionGroup.y = 1800;
	...
	addGrade1FractionTopic:function()
	{
		...
		_this.fractions1_1AScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.fractions1_1AScreenTxt.anchor.setTo(0.5);
		...
		/*_this.fractions1_1BScreen = _this.add.sprite(300,120,'fractions1_1BScreen');
		//_this.fractions1_1BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		...
		_this.fractions1_1BScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.fractions1_1BScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_1BScreenTxt.fill = 'white';
		...
		_this.fractions1_1BScreen.name = "Fractions 1.1 A";
		...
		_this.fractions1_2AScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.fractions1_2AScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_2AScreenTxt.fill = 'white';
		...
		_this.fractions1_2AScreen.name = "Fractions 1.1 A";
		...
		_this.fractions1_2BScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_2BScreenTxt.fill = 'white';
		...
		_this.fractions1_2BScreen.name = "Fractions 1.1 A";
		...
		/*_this.fractions1_3AScreen = _this.add.sprite(100,320,'fractions1_3AScreen');
		//_this.fractions1_3AScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_3AScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_3AScreenTxt = this.add.text(225, 392, ' \n 5 \n ');
		_this.fractions1_3AScreenTxt.anchor.setTo(0.5);
		_this.fractions1_3AScreenTxt.align = 'center';
		
				
		_this.fractions1_3AScreenTxt.font = 'gradefont';
		_this.fractions1_3AScreenTxt.fontSize = 20;
		_this.fractions1_3AScreenTxt.fontWeight = 'normal';
		_this.fractions1_3AScreenTxt.fill = 'white';

		_this.fractions1_3AScreenTxt.wordWrap = true;
		_this.fractions1_3AScreenTxt.wordWrapWidth = 500;
		//_this.fractions1_3AScreenTxt.setTextBounds(0,0,500,500);
		//_this.fractions1_3AScreenTxt.padding.set(50, 50);
		
		
		//_this.fractions1_3AScreenTxt.useAdvancedWrap  = true;
		

		//_this.fractions1_3AScreenTxt.setShadow(0, 0, 'rgba(0, 0, 0, 0)', 0);
		

		_this.fractions1_3AScreen.inputEnabled = true;
		_this.fractions1_3AScreen.input.useHandCursor = true;
		_this.fractions1_3AScreen.name = "Fractions 1.1 A";
		_this.fractions1_3AScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('grade1_3Alevel1',true,false);
				}
			},_this);
			
		},_this);

		_this.fractions1_3BScreen = _this.add.sprite(300,320,'fractions1_3BScreen');
		//_this.fractions1_3BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_3BScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_3BScreenTxt = this.add.text(425, 392, ' \n 6 \n ');
		_this.fractions1_3BScreenTxt.anchor.setTo(0.5);
		_this.fractions1_3BScreenTxt.align = 'center';
		
				
		_this.fractions1_3BScreenTxt.font = 'gradefont';
		_this.fractions1_3BScreenTxt.fontSize = 20;
		_this.fractions1_3BScreenTxt.fontWeight = 'normal';
		_this.fractions1_3BScreenTxt.fill = 'white';

		_this.fractions1_3BScreenTxt.wordWrap = true;
		_this.fractions1_3BScreenTxt.wordWrapWidth = 500;
		//_this.fractions1_3BScreenTxt.setTextBounds(0,0,500,500);
		//_this.fractions1_3BScreenTxt.padding.set(50, 50);
		
		
		//_this.fractions1_3BScreenTxt.useAdvancedWrap  = true;
		

		//_this.fractions1_3BScreenTxt.setShadow(0, 0, 'rgba(0, 0, 0, 0)', 0);
		

		_this.fractions1_3BScreen.inputEnabled = true;
		_this.fractions1_3BScreen.input.useHandCursor = true;
		_this.fractions1_3BScreen.name = "Fractions 1.1 A";
		_this.fractions1_3BScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('grade1_3Blevel1',true,false);
				}
			},_this);
			
		},_this);

		_this.fractions1_4Screen = _this.add.sprite(500,320,'fractions1_2CScreen');
		//_this.fractions1_4ScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_4ScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_4ScreenTxt = this.add.text(625, 392, ' \n 7 \n ');
		_this.fractions1_4ScreenTxt.anchor.setTo(0.5);
		_this.fractions1_4ScreenTxt.align = 'center';
		
				
		_this.fractions1_4ScreenTxt.font = 'gradefont';
		_this.fractions1_4ScreenTxt.fontSize = 20;
		_this.fractions1_4ScreenTxt.fontWeight = 'normal';
		_this.fractions1_4ScreenTxt.fill = 'white';

		_this.fractions1_4ScreenTxt.wordWrap = true;
		_this.fractions1_4ScreenTxt.wordWrapWidth = 500;
		//_this.fractions1_4ScreenTxt.setTextBounds(0,0,500,500);
		//_this.fractions1_4ScreenTxt.padding.set(50, 50);
		
		
		//_this.fractions1_4ScreenTxt.useAdvancedWrap  = true;
		

		//_this.fractions1_4ScreenTxt.setShadow(0, 0, 'rgba(0, 0, 0, 0)', 0);
		

		_this.fractions1_4Screen.inputEnabled = true;
		_this.fractions1_4Screen.input.useHandCursor = true;
		_this.fractions1_4Screen.name = "Fractions 1.1 A";
		_this.fractions1_4Screen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('grade1_4level1',true,false);
				}
			},_this);
		...
		*/
		...
		_this.grade1FractionGroup.add(_this.bgGraphic1);
		_this.grade1FractionGroup.add(_this.fractions1_1AScreenTxt);

		//_this.grade1FractionGroup.add(_this.fractions1_1BScreen);
		//_this.grade1FractionGroup.add(_this.bgGraphic2);
		//_this.grade1FractionGroup.add(_this.fractions1_1BScreenTxt);

		_this.grade1FractionGroup.add(_this.fractions1_2AScreen);
		_this.grade1FractionGroup.add(_this.bgGraphic3);
		_this.grade1FractionGroup.add(_this.fractions1_2AScreenTxt);

		_this.grade1FractionGroup.add(_this.fractions1_2BScreen);
		_this.grade1FractionGroup.add(_this.bgGraphic4);
		_this.grade1FractionGroup.add(_this.fractions1_2BScreenTxt);

		/*_this.grade1FractionGroup.add(_this.fractions1_3AScreen);
		_this.grade1FractionGroup.add(_this.bgGraphic5);
		_this.grade1FractionGroup.add(_this.fractions1_3AScreenTxt);

		_this.grade1FractionGroup.add(_this.fractions1_3BScreen);
		_this.grade1FractionGroup.add(_this.bgGraphic6);
		_this.grade1FractionGroup.add(_this.fractions1_3BScreenTxt);

		_this.grade1FractionGroup.add(_this.fractions1_4Screen);
		_this.grade1FractionGroup.add(_this.bgGraphic7);
		_this.grade1FractionGroup.add(_this.fractions1_4ScreenTxt);*/
	...
	QuantityNumeralTopic:function()
	{
		...
		_this.CountingIcecreams1_1ScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.CountingIcecreams1_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.CountingIcecreams1_1ScreenTxt.fill = 'white';
		...
		_this.PluckingMangoes1_2ScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.PluckingMangoes1_2ScreenTxt.anchor.setTo(0.5);
		...
		_this.PluckingMangoes1_2ScreenTxt.fill = 'white';
		...
		_this.CountingFish1_3ScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.CountingFish1_3ScreenTxt.anchor.setTo(0.5);
		...
		_this.CountingFish1_3ScreenTxt.fill = 'white';
		...
		_this.CountingFlowers1_4ScreenTxt = this.add.text(825, 192, ' \n 4 \n ');
		_this.CountingFlowers1_4ScreenTxt.anchor.setTo(0.5);
		...
		_this.CountingFlowers1_4ScreenTxt.fill = 'white';
		...
		_this.PluckingMangoes1_5ScreenTxt = this.add.text(225, 392, ' \n 5 \n ');
		_this.PluckingMangoes1_5ScreenTxt.anchor.setTo(0.5);
		...
		_this.PluckingMangoes1_5ScreenTxt.fill = 'white';
		...
		_this.BurstingBubbles1_6ScreenTxt = this.add.text(425, 392, ' \n 6 \n ');
		_this.BurstingBubbles1_6ScreenTxt.anchor.setTo(0.5);
		...
		_this.BurstingBubbles1_6ScreenTxt.fill = 'white';
		...
		_this.TracingNumbers1_7ScreenTxt = this.add.text(625, 392, ' \n 7 \n ');
		_this.TracingNumbers1_7ScreenTxt.anchor.setTo(0.5);
		...
		_this.TracingNumbers1_7ScreenTxt.fill = 'white';
		...
		_this.hungryRabbit6_1Screen = _this.add.sprite(700,320,'unity6.1');
		...
		_this.hungryRabbit6_1ScreenTxt = this.add.text(825, 392, ' \n 8 \n ');
		_this.hungryRabbit6_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic1);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic2);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic3);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic4);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic5);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic6);
		...
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic7);
		_this.grade1QuantityNumeralGroup.add(_this.TracingNumbers1_7ScreenTxt);

		_this.grade1QuantityNumeralGroup.add(_this.hungryRabbit6_1Screen);
		_this.grade1QuantityNumeralGroup.add(_this.bgGraphic8);
		_this.grade1QuantityNumeralGroup.add(_this.hungryRabbit6_1ScreenTxt);
	...
	Sequence:function()
	{
		...
		_this.Caterpillar2_1_1ScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.Caterpillar2_1_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.Caterpillar2_1_1ScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_2_1ScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.Caterpillar2_2_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.Caterpillar2_2_1ScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_3_1ScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.Caterpillar2_3_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.Caterpillar2_3_1ScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_4_1ScreenTxt = this.add.text(825, 192, ' \n 4 \n ');
		_this.Caterpillar2_4_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.Caterpillar2_4_1ScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_5_1ScreenTxt = this.add.text(225, 392, ' \n 5 \n ');
		_this.Caterpillar2_5_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.Caterpillar2_5_1ScreenTxt.fill = 'white';
		...
		_this.NumberPuzzle2_6_1ScreenTxt = this.add.text(425, 392, ' \n 6 \n ');
		_this.NumberPuzzle2_6_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.NumberPuzzle2_6_1ScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_1_1aScreenTxt = this.add.text(625, 392, '7');
		...
		_this.Caterpillar2_1_1aScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_2_1aScreenTxt = this.add.text(825, 392, '8');
		...
		_this.Caterpillar2_2_1aScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_3_1aScreenTxt = this.add.text(225, 592, '9');
		...
		_this.Caterpillar2_3_1aScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_4_1aScreenTxt = this.add.text(425, 592, '10');
		...
		_this.Caterpillar2_4_1aScreenTxt.fill = 'white';
		...
		_this.Caterpillar2_5_1aScreenTxt = this.add.text(625, 592, '11');
		...
		_this.Caterpillar2_5_1aScreenTxt.fill = 'white';
	...
	ComparisionOfNumbers:function()
	{
		...
		_this.TheCrocodile4_1_1ScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.TheCrocodile4_1_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.TheCrocodile4_1_1ScreenTxt.fill = 'white';
		...
		_this.TheCrocodile4_2_1ScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.TheCrocodile4_2_1ScreenTxt.anchor.setTo(0.5);
		...
		_this.TheCrocodile4_2_1ScreenTxt.fill = 'white';
		...
		_this.TheCrocodile4_3_1ScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		...
		_this.TheCrocodile4_3_1ScreenTxt.fill = 'white';
		...
		_this.TreeClimbing4_4_1ScreenTxt = this.add.text(825, 192, ' \n 4 \n ');
		...
		_this.TreeClimbing4_4_1ScreenTxt.fill = 'white';
		...
		_this.TreeClimbing4_5_1ScreenTxt = this.add.text(225, 392, ' \n 5 \n ');
		...
		_this.TreeClimbing4_5_1ScreenTxt.fill = 'white';
		...
		_this.TheCrocodile4_1_1NewScreen = _this.add.sprite(300,320,'unity4_1_1New');
		//_this.PluckingMangoes1_5ScreenTxt = _this.add.sprite(175,455,'Plucking mangoes 1.5');
		//_this.PluckingMangoes1_5ScreenTxt.anchor.setTo(0.5);
		...
		_this.TheCrocodile4_1_1NewScreenTxt = this.add.text(425, 392, ' \n 6 \n ');
		_this.TheCrocodile4_1_1NewScreenTxt.anchor.setTo(0.5);
		_this.TheCrocodile4_1_1NewScreenTxt.align = 'center';
		
				
		_this.TheCrocodile4_1_1NewScreenTxt.font = 'gradefont';
		_this.TheCrocodile4_1_1NewScreenTxt.fontSize = 20;
		_this.TheCrocodile4_1_1NewScreenTxt.fontWeight = 'normal';
		_this.TheCrocodile4_1_1NewScreenTxt.fill = 'white';

		_this.TheCrocodile4_1_1NewScreenTxt.wordWrap = true;
		_this.TheCrocodile4_1_1NewScreenTxt.wordWrapWidth = 500;
		//_this.TreeClimbing4_5_1ScreenTxt.setTextBounds(0,0,500,500);
		//_this.TreeClimbing4_5_1ScreenTxt.padding.set(50, 50);
		...
		_this.TheCrocodile4_1_1NewScreen.inputEnabled = true;
		_this.TheCrocodile4_1_1NewScreen.input.useHandCursor = true;
		_this.TheCrocodile4_1_1NewScreen.name = "Fractions 1.1 A";
		_this.TheCrocodile4_1_1NewScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('unity4_1_1Newlevel1',true,false);
				}
			},_this);
		...
		_this.ComparisionOfNumbersGroup.add(_this.bgGraphic4);
		...
		_this.ComparisionOfNumbersGroup.add(_this.bgGraphic5);
		_this.ComparisionOfNumbersGroup.add(_this.TreeClimbing4_5_1ScreenTxt);

		_this.ComparisionOfNumbersGroup.add(_this.TheCrocodile4_1_1NewScreen);
		_this.ComparisionOfNumbersGroup.add(_this.bgGraphic6);
		_this.ComparisionOfNumbersGroup.add(_this.TheCrocodile4_1_1NewScreenTxt);
	...
	additionQuantityTopic:function()
	{
		...
		_this.hungryRabbit5_1ScreenTxt.fill = 'white';
		...
		_this.coinMachine7_1_1ScreenTxt.fill = 'white';
		...
		_this.coinMachine7_2_1ScreenTxt.fill = 'white';
	...
	SubtractionWithQuantity:function()
	{
		...
		_this.hungryRabbit8_1ScreenTxt.fill = 'white';
		...
		_this.coinMachine10_1_1ScreenTxt.fill = 'white';
				...
				if(_this.tap)
				{
					...
					_this.time.events.add(1000, function(){
						...
						_this.time.events.add(6000, function(){
							_this.playDemoVideos('10_1_1b');
						},_this);
						_this.time.events.add(12500, function(){
							_this.playDemoVideos('10_1_1c');
						},_this);
					},_this);
		...
		_this.coinMachine10_2_1ScreenTxt.fill = 'white';
	...
	MultiplicationWithQuantity:function()
	{
		...
		_this.AforApple11_1ScreenTxt.fill = 'white';
		...
		_this.AforApple11_2ScreenTxt.fill = 'white';
		...
		_this.multiplication12_3_1ScreenTxt.fill = 'white';
	...
	PlaceValue:function()
	{
		...
		_this.placeValue3_1_1aScreen = _this.add.sprite(100,120,'unity3.1.1a');
		//_this.placeValue3_1_1aScreenTxt = _this.add.sprite(165,255,'Coin Machine 3.1.1');
		//_this.placeValue3_1_1aScreenTxt.anchor.setTo(0.5);
		...
		_this.placeValue3_1_1aScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.placeValue3_1_1aScreenTxt.anchor.setTo(0.5);
		_this.placeValue3_1_1aScreenTxt.align = 'center';
		
				
		_this.placeValue3_1_1aScreenTxt.font = 'gradefont';
		_this.placeValue3_1_1aScreenTxt.fontSize = 20;
		_this.placeValue3_1_1aScreenTxt.fontWeight = 'normal';
		_this.placeValue3_1_1aScreenTxt.fill = 'white';

		_this.placeValue3_1_1aScreenTxt.wordWrap = true;
		_this.placeValue3_1_1aScreenTxt.wordWrapWidth = 500;
		//_this.placeValue3_1_1aScreenTxt.setTextBounds(0,0,500,500);
		//_this.placeValue3_1_1aScreenTxt.padding.set(50, 50);
		
		
		//_this.placeValue3_1_1aScreenTxt.useAdvancedWrap  = true;
		

		//_this.placeValue3_1_1aScreenTxt.setShadow(0, 0, 'rgba(0, 0, 0, 0)', 0);
		

		_this.placeValue3_1_1aScreen.inputEnabled = true;
		_this.placeValue3_1_1aScreen.input.useHandCursor = true;
		_this.placeValue3_1_1aScreen.name = "Fractions 1.1 A";
		_this.placeValue3_1_1aScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('unity3_1_1alevel1',true,false);
				}
			},_this);
		...
		_this.placeValue3_1_1bScreen = _this.add.sprite(300,120,'unity3.1.1b');
		//_this.placeValue3_1_1aScreenTxt = _this.add.sprite(165,255,'Coin Machine 3.1.1');
		//_this.placeValue3_1_1aScreenTxt.anchor.setTo(0.5);
		...
		_this.placeValue3_1_1bScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.placeValue3_1_1bScreenTxt.anchor.setTo(0.5);
		_this.placeValue3_1_1bScreenTxt.align = 'center';
		
				
		_this.placeValue3_1_1bScreenTxt.font = 'gradefont';
		_this.placeValue3_1_1bScreenTxt.fontSize = 20;
		_this.placeValue3_1_1bScreenTxt.fontWeight = 'normal';
		_this.placeValue3_1_1bScreenTxt.fill = 'white';

		_this.placeValue3_1_1bScreenTxt.wordWrap = true;
		_this.placeValue3_1_1bScreenTxt.wordWrapWidth = 500;
		//_this.placeValue3_1_1aScreenTxt.setTextBounds(0,0,500,500);
		//_this.placeValue3_1_1aScreenTxt.padding.set(50, 50);
		...
		_this.placeValue3_1_1bScreen.inputEnabled = true;
		_this.placeValue3_1_1bScreen.input.useHandCursor = true;
		_this.placeValue3_1_1bScreen.name = "Fractions 1.1 A";
		_this.placeValue3_1_1bScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('unity3_1_1blevel1',true,false);
				}
			},_this);
		...
		_this.PlaceValueGroup.add(_this.placeValue3_1_1aScreen);
		_this.PlaceValueGroup.add(_this.bgGraphic1);
		_this.PlaceValueGroup.add(_this.placeValue3_1_1aScreenTxt);

		_this.PlaceValueGroup.add(_this.placeValue3_1_1bScreen);
		_this.PlaceValueGroup.add(_this.bgGraphic2);
		_this.PlaceValueGroup.add(_this.placeValue3_1_1bScreenTxt);
	 ...
	 playDemoVideos:function(target){
        ...
        switch(target)
        {
            case '7_1_1':  if(window.languageSelected == "English")
							{
            ...
            case '7_2_1a':  if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 7.2.1a.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 7.2.1a.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 7.2.1a.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/7.2.1a.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
		    case '7_2_1b':  if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 7.2.1b.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 7.2.1b.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 7.2.1b.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/7.2.1b.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
            case '10_1_1a': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 10.1.1a.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 10.1.1a.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 10.1.1a.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/10.1.1a.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
			case '10_1_1b': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 10.1.1b.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 10.1.1b.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 10.1.1b.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/10.1.1b.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
			case '10_1_1c': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 10.1.1c.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 10.1.1c.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 10.1.1c.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/10.1.1c.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
            case '10_2_1a':  if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 10.2.1a.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 10.2.1a.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 10.2.1a.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/10.2.1a.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
			case '10_2_1b':  if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/English/Game 10.2.1b.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Hindi/Game 10.2.1b.mp3");
							}
							else if(window.languageSelected=="Kannada")
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Kannada/Game 10.2.1b.mp3");
							}
							else
							{
								_this.src.setAttribute("src", "assets/DemoVOs/Odiya/10.2.1b.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
