Game.grade1Shapes=function(game){
	
};

Game.grade1Shapes.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade1ShapeScreen");
		
		_this = this;

		this.game.input.enabled = false;

		 grade1ShapesSenseSelected = true;
	...
	spatialRelationshipTopic:function()
	{
		...
		_this.spatialRelationship1 = _this.add.sprite(100,120,'shape 1.1.1');
		...
		_this.spatialRelationship1.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg1_1_1level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship2 = _this.add.sprite(300,120,'shape 2.1.1');
		...
		_this.spatialRelationship2.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg2_1_1level1',true,false);
				}
			},_this);
			
		},_this);

		_this.spatialRelationship3 = _this.add.sprite(500,120,'shape 2.2.1');
		...
		_this.spatialRelationship3.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg2_2_1level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship4 = _this.add.sprite(700,120,'shape 3.1.1');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship4.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg3_1_1level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship5 = _this.add.sprite(100,320,'shape 3.2.1');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship5.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg3_2_1level1',true,false);
				}
			},_this);
			
		},_this);

		_this.spatialRelationship6 = _this.add.sprite(300,320,'shape 4.1.1');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship6.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg4_1_1level1',true,false);
				}
			},_this);
			
		},_this);

		_this.spatialRelationship7 = _this.add.sprite(500,320,'shape 4.2.1');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship7.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg4_2_1level1',true,false);
				}
			},_this);
