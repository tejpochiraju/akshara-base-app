Game.grade2Measurement=function(game){
	
};

Game.grade2Measurement.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade2NumberOperation");
		...
		grade1NumberSenseSelected = false;
		 ...
		 grade2MeasurementSelected = true;
	...
	Sequence:function()
	{
		...
		_this.Caterpillar2_3_2aScreen = _this.add.sprite(100,720,'unity2_3_1aScreen');
		...
		_this.Caterpillar2_4_2aScreen = _this.add.sprite(300,720,'unity2_4_1aScreen');
		...
		_this.Caterpillar2_5_2aScreen = _this.add.sprite(500,720,'unity2_5_1a');
...
*/
				...
				if(_this.tap)
				{
					...
					this.video2.playbackRate = 1;    // slow down the video
						_this.time.events.add(500, function(){
							...
							_this.time.events.add(24000, function(){
								_this.playDemoVideos('7_2_2b');
	...
	DivisionWithQuantity:function()
	{
		...
		//_this.Division16_2ScreenTxt = this.add.text(175, 265, ' \n '+window.selctedLang.FishInATank15_1+' \n ');
		_this.Division16_3ScreenTxt = this.add.text(825, 192, '4');
		...
		_this.division17_2ScreenTxt = this.add.text(225, 392, '5');
		_this.division17_2ScreenTxt.anchor.setTo(0.5);
		...
		_this.division17_3ScreenTxt = this.add.text(425, 392, '6');
		_this.division17_3ScreenTxt.anchor.setTo(0.5);
	 ...
	 playDemoVideos:function(target){
        ...
        switch(target)
        {
            case '3_2_1a':  if(window.languageSelected == "English")
							...
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Odiya/Game 3.2.1a.mp3");
			...
			case '3_2_1b':  if(window.languageSelected == "English")
							...
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Odiya/Game 3.2.1b.mp3");
								_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
            ...
            case '10_1_2a': if(window.languageSelected == "English")
							...
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Gujarati/10.1.2a.mp3");
							}
							else
							{
			...
			case '10_1_2b': if(window.languageSelected == "English")
							...
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Gujarati/10.1.2b.mp3");
							}
							else
							{
