Game.grade2NumberSense=function(game){
	
};

Game.grade2NumberSense.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade2NumberScene");
		...
		grade1NumberSenseSelected = false;
		 ...
		 grade2NumberSenseSelected = true;
...
*/
		...
		_this.TheCrocodile4_2_2NewScreen = _this.add.sprite(500,120,'unity4_2_2');
		//_this.PluckingMangoes1_5ScreenTxt = _this.add.sprite(175,455,'Plucking mangoes 1.5');
		//_this.PluckingMangoes1_5ScreenTxt.anchor.setTo(0.5);
		...
		_this.TheCrocodile4_2_2NewScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.TheCrocodile4_2_2NewScreenTxt.anchor.setTo(0.5);
		_this.TheCrocodile4_2_2NewScreenTxt.align = 'center';
		
				
		_this.TheCrocodile4_2_2NewScreenTxt.font = 'gradefont';
		_this.TheCrocodile4_2_2NewScreenTxt.fontSize = 20;
		_this.TheCrocodile4_2_2NewScreenTxt.fontWeight = 'normal';
		_this.TheCrocodile4_2_2NewScreenTxt.fill = 'white';

		_this.TheCrocodile4_2_2NewScreenTxt.wordWrap = true;
		_this.TheCrocodile4_2_2NewScreenTxt.wordWrapWidth = 500;
		...
		_this.TheCrocodile4_2_2NewScreen.inputEnabled = true;
		_this.TheCrocodile4_2_2NewScreen.input.useHandCursor = true;
		_this.TheCrocodile4_2_2NewScreen.name = "Fractions 1.1 A";
		_this.TheCrocodile4_2_2NewScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('unity4_2_2level1',true,false);
				}
			},_this);
		...
		_this.ComparisionOfNumbersGroup.add(_this.TheCrocodile4_2_2NewScreen);
		_this.ComparisionOfNumbersGroup.add(_this.bgGraphic6);
		_this.ComparisionOfNumbersGroup.add(_this.TheCrocodile4_2_2NewScreenTxt);
