Game.grade2Shapes=function(game){
	
};

Game.grade2Shapes.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade2ShapeScreen");
		...
		this.game.input.enabled = false;
		 ...
		 grade2ShapesSenseSelected = true;
	...
	spatialRelationshipTopic:function()
	{
		...
		_this.spatialRelationship1 = _this.add.sprite(100,120,'shape 5.1.2');
		...
		_this.spatialRelationship1.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg5_1_2level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship2 = _this.add.sprite(300,120,'shape 7.1.2');
		...
		_this.spatialRelationship2.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg7_1_2level1',true,false);
				}
			},_this);
			
		},_this);

		_this.spatialRelationship3 = _this.add.sprite(500,120,'shape 7.2.2');
		...
		_this.spatialRelationship3.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg7_2_2level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship4 = _this.add.sprite(700,120,'shape 7.2.2x');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship4.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg7_2_2xlevel1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship5 = _this.add.sprite(100,320,'shape 8.1.2');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship6 = _this.add.sprite(300,320,'shape 8.2.2x');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship7 = _this.add.sprite(500,320,'shape 8.2.2');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
