Game.grade3NumberSense=function(game){
	
};

Game.grade3NumberSense.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade3NumberScene");
		...
		grade1ShapesSenseSelected = false;
		 ...
		 grade3NumberSenseSelected = true;
		...
		_this.sequenceGroup.x = 0;
		_this.sequenceGroup.y = 0;

		_this.ComparisionOfNumbersGroup.x = 0;
		_this.ComparisionOfNumbersGroup.y = 650;

		_this.PlaceValueGroup.x = 0;
		_this.PlaceValueGroup.y = 900;

		_this.grade1FractionGroup.x = 0;
		_this.grade1FractionGroup.y = 1150;
	...
	addGrade1FractionTopic:function()
	{
		...
		_this.fractions1_1BScreen = _this.add.sprite(100,120,'fractions1_1BScreen');
		...
		_this.fractions1_1BScreenTxt = this.add.text(225, 192, ' \n 1 \n ');
		_this.fractions1_1BScreenTxt.anchor.setTo(0.5);
		...
		/*_this.fractions1_2AScreen = _this.add.sprite(500,120,'fractions1_2AScreen');
		...
		_this.fractions1_2AScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.fractions1_2AScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_2BScreen = _this.add.sprite(700,120,'fractions1_2BScreen');
		...
		_this.fractions1_2BScreenTxt = this.add.text(825, 192, ' \n 4 \n ');
		_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		*/
		_this.fractions1_3AScreen = _this.add.sprite(300,120,'fractions1_3AScreen');
		//_this.fractions1_3AScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_3AScreenTxt.anchor.setTo(0.5);

		_this.bgGraphic5 = this.add.graphics(410,175);
		...
		_this.fractions1_3AScreenTxt = this.add.text(425, 192, ' \n 2 \n ');
		_this.fractions1_3AScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_3BScreen = _this.add.sprite(500,120,'fractions1_3BScreen');
		//_this.fractions1_3BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_3BScreenTxt.anchor.setTo(0.5);

		_this.bgGraphic6 = this.add.graphics(610,175);
		...
		_this.fractions1_3BScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.fractions1_3BScreenTxt.anchor.setTo(0.5);
		...
		_this.fractions1_4Screen = _this.add.sprite(700,120,'fractions1_2CScreen');
		//_this.fractions1_4ScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_4ScreenTxt.anchor.setTo(0.5);

		_this.bgGraphic7 = this.add.graphics(810,175);
		...
		_this.fractions1_4ScreenTxt = this.add.text(825, 192, ' \n 4 \n ');
		_this.fractions1_4ScreenTxt.anchor.setTo(0.5);
...
*/
		...
		_this.SmallorBig4_6_1Screen = _this.add.sprite(700,120,'unity4_6_1');
		//_this.PluckingMangoes1_5ScreenTxt = _this.add.sprite(175,455,'Plucking mangoes 1.5');
		//_this.PluckingMangoes1_5ScreenTxt.anchor.setTo(0.5);

		_this.bgGraphic3 = this.add.graphics(810,175);
		_this.bgGraphic3.lineStyle(0, 0xFFFFFF, 0.8);
		_this.bgGraphic3.beginFill(0x493A19, 1);
		_this.bgGraphic3.drawRoundedRect(0,0,30,30,10);
		_this.bgGraphic3.boundsPadding = 0;

		_this.SmallorBig4_6_1ScreenTxt = this.add.text(825, 192, ' \n 4 \n ');
		...
		_this.TheCrocodile4_2_3NewScreen = _this.add.sprite(500,120,'unity4_2_3');
		//_this.PluckingMangoes1_5ScreenTxt = _this.add.sprite(175,455,'Plucking mangoes 1.5');
		//_this.PluckingMangoes1_5ScreenTxt.anchor.setTo(0.5);
		...
		_this.TheCrocodile4_2_3NewScreenTxt = this.add.text(625, 192, ' \n 3 \n ');
		_this.TheCrocodile4_2_3NewScreenTxt.anchor.setTo(0.5);
		_this.TheCrocodile4_2_3NewScreenTxt.align = 'center';
		
				
		_this.TheCrocodile4_2_3NewScreenTxt.font = 'gradefont';
		_this.TheCrocodile4_2_3NewScreenTxt.fontSize = 20;
		_this.TheCrocodile4_2_3NewScreenTxt.fontWeight = 'normal';
		_this.TheCrocodile4_2_3NewScreenTxt.fill = 'white';

		_this.TheCrocodile4_2_3NewScreenTxt.wordWrap = true;
		_this.TheCrocodile4_2_3NewScreenTxt.wordWrapWidth = 500;
		...
		_this.TheCrocodile4_2_3NewScreen.inputEnabled = true;
		_this.TheCrocodile4_2_3NewScreen.input.useHandCursor = true;
		_this.TheCrocodile4_2_3NewScreen.name = "Fractions 1.1 A";
		_this.TheCrocodile4_2_3NewScreen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('unity4_2_3level1',true,false);
				}
			},_this);
		...
		_this.ComparisionOfNumbersGroup.add(_this.TheCrocodile4_2_3NewScreen);
		_this.ComparisionOfNumbersGroup.add(_this.bgGraphic6);
		_this.ComparisionOfNumbersGroup.add(_this.TheCrocodile4_2_3NewScreenTxt);
		...
		_this.coinMachine7_1_2Screen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					this.video1.changeSource(window.baseUrl+"assets/demoVideos/7_1_2.mp4");
					this.video1.addToWorld();
					this.video1.play(false);
					//this.game.input.enabled = false;
		...
		_this.coinMachine7_2_2Screen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					this.video2.changeSource(window.baseUrl+"assets/demoVideos/7_2_2.mp4");
					this.video2.addToWorld();
					this.video2.play(false);
					//this.game.input.enabled = false;
		...
		_this.coinMachine10_1_2Screen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					this.video3.changeSource(window.baseUrl+"assets/demoVideos/10_1_2.mp4");
					this.video3.addToWorld();
					this.video3.play(false);
					//this.game.input.enabled = false;
		...
		_this.coinMachine10_2_2Screen.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					this.video4.changeSource(window.baseUrl+"assets/demoVideos/10_2_2.mp4");
					this.video4.addToWorld();
					this.video4.play(false);
					//this.game.input.enabled = false;
					...
					_this.time.events.add(400, function(){
						...
						_this.time.events.add(25000, function(){
	 ...
	 playDemoVideos:function(target){
        ...
        switch(target)
        {
			...
			case '7_1_2b': if(window.languageSelected == "English")
							...
							break;
            case '7_2_2a': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/English/Game 7.2.2a.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Hindi/Game 7.2.2a.mp3");
							}
							else if(window.languageSelected == "Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Kannada/Game 7.2.2a.mp3");
							}
							else
							{
							...
							break;
			case '7_2_2b': if(window.languageSelected == "English")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/English/Game 7.2.2b.mp3");
							}
							else if(window.languageSelected == "Hindi")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Hindi/Game 7.2.2b.mp3");
							}
							else if(window.languageSelected == "Kannada")
							{
								_this.src.setAttribute("src", window.baseUrl+"assets/DemoVOs/Kannada/Game 7.2.2b.mp3");
							}
							else
							{
