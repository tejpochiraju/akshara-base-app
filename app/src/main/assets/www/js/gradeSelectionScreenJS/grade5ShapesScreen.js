Game.grade5Shapes=function(game){
	
};

Game.grade5Shapes.prototype={
	...
	create:function(game){
		...
		nativeApp.screenViewStringPass("Practice_activity_list","grade5ShapeScreen");
		...
		this.game.input.enabled = false;
		 ...
		 grade5ShapesSenseSelected = true;
	...
	spatialRelationshipTopic:function()
	{
		...
		_this.spatialRelationship1 = _this.add.sprite(100,120,'shape 21.1.5');
		...
		_this.spatialRelationship1.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg21_1_5level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship2 = _this.add.sprite(300,120,'shape 21.2.5');
		...
		_this.spatialRelationship2.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg21_2_5level1',true,false);
				}
			},_this);
			
		},_this);

		_this.spatialRelationship3 = _this.add.sprite(500,120,'shape 21.3.5');
		...
		_this.spatialRelationship3.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg21_3_5level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship4 = _this.add.sprite(700,120,'shape 22.1.5');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship4.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg22_1_5level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship5 = _this.add.sprite(100,320,'shape 23.1.5');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship5.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg23_1_5level1',true,false);
				}
			},_this);
		...
		_this.spatialRelationship6 = _this.add.sprite(300,320,'shape 21.3.6');
		//_this.fractions1_2BScreenTxt = _this.add.sprite(175,250,'pinwheel1_1A');
		//_this.fractions1_2BScreenTxt.anchor.setTo(0.5);
		...
		_this.spatialRelationship6.events.onInputDown.add(function(target){
			...
			_this.time.events.add(300, function(){
				...
				if(_this.tap)
				{
					...
					_this.state.start('sg21_3_6level1',true,false);
				}
			},_this);
