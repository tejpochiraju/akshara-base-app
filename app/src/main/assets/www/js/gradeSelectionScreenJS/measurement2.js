Game.measurement2=function(){

};


Game.measurement2.prototype={
	
	init:function()
	{
		_this = this;
		window.mcIcon = "weight";
	...
	create:function(){		
		...
		nativeApp.screenViewStringPass("Challenge_activity_list","measurement2");
		...
		this.lengthMc = this.add.sprite(250,20,'weightMc');
		this.lengthMc.anchor.setTo(0.5);


		this.measurement1_1State = localStorage.getItem(window.avatarName+"weight_MWG_1_1state");
		this.measurement1_2State = localStorage.getItem(window.avatarName+"weight_MWG_2_2state");
		this.measurement1_3State = localStorage.getItem(window.avatarName+"weight_MWG_3_2state");
	...
	{
		this.measurement1_1 = this.add.sprite(this.world.centerX-250,200,"measurement2_1");
		...
		if(this.measurement1_1State=="playedwithhint"||this.measurement1_1State=="canplay")
		{
			...
			this.measurement1_1.events.onInputDown.add(function()
			{
				if(this.measurement1_1State=="playedwithhint")
				{
        			...
        			this.deductScore(this,-5,false,false,null,'weight_MWG_1_1level1');
				}
				else
					this.state.start('weight_MWG_1_1level1',true,false);
			},this);
		}

		this.measurement1_2 = this.add.sprite(this.world.centerX,200,"measurement2_2");
		...
		if(this.measurement1_2State=="playedwithhint"||this.measurement1_2State=="canplay")
		{
			...
			this.measurement1_2.events.onInputDown.add(function()
			{
				if(this.measurement1_2State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'weight_MWG_2_2level1');
				}
				else
					this.state.start('weight_MWG_2_2level1',true,false);
			},this);
		}

		this.measurement1_3 = this.add.sprite(this.world.centerX+250,200,"measurement2_3");
		...
		if(this.measurement1_3State=="playedwithhint"||this.measurement1_3State=="canplay")
		{
			...
			this.measurement1_3.events.onInputDown.add(function()
			{
				if(this.measurement1_3State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'weight_MWG_3_2level1');
				}
				else
					this.state.start('weight_MWG_3_2level1',true,false);
			},this);
		}
