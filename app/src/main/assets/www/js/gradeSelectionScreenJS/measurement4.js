Game.measurement4=function(){

};


Game.measurement4.prototype={
	
	init:function()
	{
		_this = this;
		window.mcIcon = "volume";
	...
	create:function(){	
		...
		nativeApp.screenViewStringPass("Challenge_activity_list","measurement4");
		...
		this.lengthMc = this.add.sprite(250,20,'volumeMc');
		this.lengthMc.anchor.setTo(0.5);


		this.measurement1_1State = localStorage.getItem(window.avatarName+"volume_MVG_1_4state");
		this.measurement1_2State = localStorage.getItem(window.avatarName+"volume_MVG_2_4state");
		this.measurement1_3State = localStorage.getItem(window.avatarName+"volume_MVG_3_4state");
	...
	{
		this.measurement1_1 = this.add.sprite(this.world.centerX-250,200,"measurement4_1");
		...
		if(this.measurement1_1State=="playedwithhint"||this.measurement1_1State=="canplay")
		{
			...
			this.measurement1_1.events.onInputDown.add(function()
			{
				if(this.measurement1_1State=="playedwithhint")
				{
        			...
        			this.deductScore(this,-5,false,false,null,'volume_MVG_1_4level1');
				}
				else
					this.state.start('volume_MVG_1_4level1',true,false);
			},this);
		}

		this.measurement1_2 = this.add.sprite(this.world.centerX,200,"measurement4_2");
		...
		if(this.measurement1_2State=="playedwithhint"||this.measurement1_2State=="canplay")
		{
			...
			this.measurement1_2.events.onInputDown.add(function()
			{
				if(this.measurement1_2State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'volume_MVG_2_4level1');
				}
				else
					this.state.start('volume_MVG_2_4level1',true,false);
			},this);
		}

		this.measurement1_3 = this.add.sprite(this.world.centerX+250,200,"measurement4_3");
		...
		if(this.measurement1_3State=="playedwithhint"||this.measurement1_3State=="canplay")
		{
			...
			this.measurement1_3.events.onInputDown.add(function()
			{
				if(this.measurement1_3State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'volume_MVG_3_4level1');
				}
				else
					this.state.start('volume_MVG_3_4level1',true,false);
			},this);
		}
