Game.numberoperation3=function(){

};


Game.numberoperation3.prototype={
	
	init:function()
	{
		_this = this;

		window.mcIcon = "multiplication";
	...
	numberOpertaion3 = true;	

		nativeApp.screenViewStringPass("Challenge_activity_list","numberOperation3");
		...
		this.additionMc = this.add.sprite(270,20,'multiplicationMc');
		this.additionMc.anchor.setTo(0.5);


		this.numberoperation1_1State = localStorage.getItem(window.avatarName+"multiplication_NOMG_1_1state");
		this.numberoperation1_2State = localStorage.getItem(window.avatarName+"multiplication_NOMG_2_1state");
		this.numberoperation1_3State = localStorage.getItem(window.avatarName+"multiplication_NOMG_3_1state");
		this.numberoperation1_4State = localStorage.getItem(window.avatarName+"multiplication_NOMG_4_2state");
		this.numberoperation1_5State = localStorage.getItem(window.avatarName+"multiplication_NOMG_5_3state");
	...
	{
		this.numberoperation1_1 = this.add.sprite(this.world.centerX-250,200,"numberoperation3_1");
		...
		if(this.numberoperation1_1State=="playedwithhint"||this.numberoperation1_1State=="canplay")
		{
			...
			this.numberoperation1_1.events.onInputDown.add(function()
			{
				if(this.numberoperation1_1State=="playedwithhint")
				{
        			...
        			this.deductScore(this,-5,false,false,null,'multiplication_NOMG_1_1level1');
				}
				else
					this.state.start('multiplication_NOMG_1_1level1',true,false);
			},this);
		}

		this.numberoperation1_2 = this.add.sprite(this.world.centerX,200,"numberoperation3_2");
		...
		if(this.numberoperation1_2State=="playedwithhint"||this.numberoperation1_2State=="canplay")
		{
			...
			this.numberoperation1_2.events.onInputDown.add(function()
			{
				if(this.numberoperation1_2State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'multiplication_NOMG_2_1level1');
				}
				else
					this.state.start('multiplication_NOMG_2_1level1',true,false);
			},this);
		}

		this.numberoperation1_3 = this.add.sprite(this.world.centerX+250,200,"numberoperation3_3");
		...
		if(this.numberoperation1_3State=="playedwithhint"||this.numberoperation1_3State=="canplay")
		{
			...
			this.numberoperation1_3.events.onInputDown.add(function()
			{
				if(this.numberoperation1_3State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'multiplication_NOMG_3_1level1');
				}
				else
					this.state.start('multiplication_NOMG_3_1level1',true,false);
			},this);
		}

		this.numberoperation1_4 = this.add.sprite(this.world.centerX-250,400,"numberoperation3_3");
		...
		if(this.numberoperation1_4State=="playedwithhint"||this.numberoperation1_4State=="canplay")
		{
			...
			this.numberoperation1_4.events.onInputDown.add(function()
			{
				if(this.numberoperation1_4State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'multiplication_NOMG_4_2level1');
				}
				else
					this.state.start('multiplication_NOMG_4_2level1',true,false);
			},this);
		}

		this.numberoperation1_5 = this.add.sprite(this.world.centerX,400,"numberoperation3_5");
		this.numberoperation1_5.anchor.setTo(0.5);

		this.ntext1_5 = this.add.sprite(this.world.centerX+60,445,"n5");
		this.ntext1_5.anchor.setTo(0.5);

		if(this.numberoperation1_5State=="playedwithhint"||this.numberoperation1_5State=="canplay")
		{
			this.numberoperation1_5.inputEnabled = true;
			this.numberoperation1_5.events.onInputDown.add(function()
			{
				if(this.numberoperation1_5State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'multiplication_NOMG_5_3level1');
				}
				else
					this.state.start('multiplication_NOMG_5_3level1',true,false);
			},this);
		}
		...
		this.checkState(this.numberoperation1_5,this.ntext1_5,this.numberoperation1_5State);

		//this.ntext1_1.visible = false;
		//this.ntext1_2.visible = false;
		//this.ntext1_5.visible = false;
