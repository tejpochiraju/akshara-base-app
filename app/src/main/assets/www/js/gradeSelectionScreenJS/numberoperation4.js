Game.numberoperation4=function(){

};


Game.numberoperation4.prototype={
	
	init:function()
	{
		_this = this;

		window.mcIcon = "division";
	...
	create:function(){		
		...
		numberOpertaion4 = true;

		nativeApp.screenViewStringPass("Challenge_activity_list","numberOperation4");
		...
		this.additionMc = this.add.sprite(270,20,'divisionMc');
		this.additionMc.anchor.setTo(0.5);


		this.numberoperation1_1State = localStorage.getItem(window.avatarName+"division_NODG_1_2state");
		this.numberoperation1_2State = localStorage.getItem(window.avatarName+"division_NODG_2_2state");
		this.numberoperation1_3State = localStorage.getItem(window.avatarName+"division_NODG_3_2state");
		this.numberoperation1_4State = localStorage.getItem(window.avatarName+"division_NODG_4_2state");
	...
	addgameIcons:function()
	{
		...
		if(this.numberoperation1_1State=="playedwithhint"||this.numberoperation1_1State=="canplay")
		{
			...
			this.numberoperation1_1.events.onInputDown.add(function()
			{
				if(this.numberoperation1_1State=="playedwithhint")
				{
        			...
        			this.deductScore(this,-5,false,false,null,'division_NODG_1_2level1');
				}
				else
					this.state.start('division_NODG_1_2level1',true,false);
			},this);
		}

		this.numberoperation1_2 = this.add.sprite(this.world.centerX,200,"numberoperation4_2");
		...
		if(this.numberoperation1_2State=="playedwithhint"||this.numberoperation1_2State=="canplay")
		{
			...
			this.numberoperation1_2.events.onInputDown.add(function()
			{
				if(this.numberoperation1_2State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'division_NODG_2_2level1');
				}
				else
					this.state.start('division_NODG_2_2level1',true,false);
			},this);
		}

		this.numberoperation1_3 = this.add.sprite(this.world.centerX+250,200,"numberoperation4_3");
		...
		if(this.numberoperation1_3State=="playedwithhint"||this.numberoperation1_3State=="canplay")
		{
			...
			this.numberoperation1_3.events.onInputDown.add(function()
			{
				if(this.numberoperation1_3State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'division_NODG_3_2level1');
				}
				else
					this.state.start('division_NODG_3_2level1',true,false);
			},this);
		}

		this.numberoperation1_4 = this.add.sprite(this.world.centerX-250,400,"numberoperation4_4");
		...
		if(this.numberoperation1_4State=="playedwithhint"||this.numberoperation1_4State=="canplay")
		{
			...
			this.numberoperation1_4.events.onInputDown.add(function()
			{
				if(this.numberoperation1_4State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'division_NODG_4_2level1');
				}
				else
					this.state.start('division_NODG_4_2level1',true,false);
			},this);
		}
		...
		//this.ntext1_3.visible = false;
		//this.ntext1_4.visible = false;
