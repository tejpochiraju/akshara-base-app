...
Game.numbersense5.prototype={
	...
	create:function(){		
		...
		numberSense5 = true;
		 ...
		 nativeApp.screenViewStringPass("Challenge_activity_list","numbersene5");
		...
		this.numberMc = this.add.sprite(250,20,'fractionMc');
		this.numberMc.anchor.setTo(0.5);


		this.numbersense1_1State = localStorage.getItem(window.avatarName+"fraction_NSFG_1_1state");
		this.numbersense1_2State = localStorage.getItem(window.avatarName+"fraction_NSFG_2_1state");
		this.numbersense1_3State = localStorage.getItem(window.avatarName+"fraction_NSFG_3_1state");
		this.numbersense1_4State = localStorage.getItem(window.avatarName+"fraction_NSFG_4_1state");
	...
	{
		this.numbersense1_1 = this.add.sprite(this.world.centerX-250,200,"numbersense5_1");
		...
		if(this.numbersense1_1State=="playedwithhint"||this.numbersense1_1State=="canplay")
		{
			...
			this.numbersense1_1.events.onInputDown.add(function()
			{
				if(this.numbersense1_1State=="playedwithhint")
				{
        			...
        			this.deductScore(this,-5,false,false,null,'fraction_NSFG_1_1level1');
				}
				else
					this.state.start('fraction_NSFG_1_1level1',true,false);
			},this);
		}

		this.numbersense1_2 = this.add.sprite(this.world.centerX,200,"numbersense5_2");
		...
		if(this.numbersense1_2State=="playedwithhint"||this.numbersense1_2State=="canplay")
		{
			...
			this.numbersense1_2.events.onInputDown.add(function()
			{
				if(this.numbersense1_2State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'fraction_NSFG_2_1level1');
				}
				else
					this.state.start('fraction_NSFG_2_1level1',true,false);
			},this);
		}

		this.numbersense1_3 = this.add.sprite(this.world.centerX+250,200,"numbersense5_3");
		...
		if(this.numbersense1_3State=="playedwithhint"||this.numbersense1_3State=="canplay")
		{
			...
			this.numbersense1_3.events.onInputDown.add(function()
			{
				if(this.numbersense1_3State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'fraction_NSFG_3_1level1');
				}
				else
					this.state.start('fraction_NSFG_3_1level1',true,false);
			},this);
		}

		this.numbersense1_4 = this.add.sprite(this.world.centerX-250,400,"numbersense5_4");
		...
		if(this.numbersense1_4State=="playedwithhint"||this.numbersense1_4State=="canplay")
		{
			...
			this.numbersense1_4.events.onInputDown.add(function()
			{
				if(this.numbersense1_4State=="playedwithhint")
				{
					window.score -= 5;
        			localStorage.setItem(window.avatarName+"Score", window.score);
        			this.deductScore(this,-5,false,false,null,'fraction_NSFG_4_1level1');
				}
				else
					this.state.start('fraction_NSFG_4_1level1',true,false);
			},this);
		}
