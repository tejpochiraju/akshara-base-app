...
Game.selectgrade1MicroConceptScreen.prototype={
	...
	microConceptTopics:function(game,x,y,lang,name,key,arrIndex)
	{
		...
		/*if(name=="NUMBER SENSE")
		{
			...
			this.checkDirExistsorNot(constant.checkNumberSense1Dir,this.gradeTree[arrIndex]);
			
		}
		else if(name=="MEASUREMENT")
		{
			this.checkDirExistsorNot(constant.checkMeasurement1Dir,this.gradeTree[arrIndex]);
			
		}
		else if(name=="NUMBER OPERATIONS")
		{
			this.checkDirExistsorNot(constant.checkNumberOperation1Dir,this.gradeTree[arrIndex]);
	...
	topicSelected:function(target)
	{
		...
		//{
			...
			//this.checkDownload(constant.checkNumberSense1Dir,"grade1NumberSense",constant.downloadNumberSense1,target,this);
		...
		//{
			...
			//this.checkDownload(constant.checkMeasurement1Dir,"grade1Measurement",constant.downloadMeasurement1,target,this);
		//}
		...
		//{
			...
			//this.checkDownload(constant.checkNumberOperation1Dir,"grade1NumberOperation",constant.downloadNumberOperation1,target,this);
		//}
