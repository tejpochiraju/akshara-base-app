Game.selectgrade2MicroConceptScreen=function(){

};

Game.selectgrade2MicroConceptScreen.prototype={
	...
	create:function(game){		
		...
		nativeApp.screenViewStringPass("Practice_topic_selection_screen","grade2MicroConceptScreen");

		this.game = game;

		selectgrade1MicroConcept = false;
		selectgrade2MicroConcept = true;
		selectgrade3MicroConcept = false;
		selectgrade4MicroConcept = false;
		selectgrade5MicroConcept = false;

		if(grade2NumberSenseSelected)
		{
			this.state.start('grade2NumberSense',true,false);
		}
		else if(grade2NumberOperationSelected)
		{
			this.state.start('grade2NumberOperation',true,false);
		}
		else if(grade2MeasurementSelected)
		{
			this.state.start('grade2Measurement',true,false);
		}
		else if(grade2ShapesSenseSelected)
		{
			this.state.start('grade2Shapes',true,false);
		}
		else
		{
	...
	microConceptTopics:function(game,x,y,lang,name,key,arrIndex)
	{
		...
		/*if(name=="NUMBER SENSE")
		{
			...
			this.checkDirExistsorNot(constant.checkNumberSense2Dir,this.gradeTree[arrIndex]);
			
		}
		else if(name=="MEASUREMENT")
		{
			this.checkDirExistsorNot(constant.checkMeasurement2Dir,this.gradeTree[arrIndex]);
			
		}
		else if(name=="NUMBER OPERATIONS")
		{
			this.checkDirExistsorNot(constant.checkNumberOperation2Dir,this.gradeTree[arrIndex]);
	...
	topicSelected:function(target)
	{
		...
		//{
			...
			//this.checkDownload(constant.checkNumberSense2Dir,"grade2NumberSense",constant.downloadNumberSense2,target,this);
		...
		//	this.checkDownload(constant.checkMeasurement2Dir,"grade2Measurement",constant.downloadMeasurement2,target,this);
		//}
		...
		//{
			...
			//this.checkDownload(constant.checkNumberOperation2Dir,"grade2NumberOperation",constant.downloadNumberOperation2,target,this);
		//}
	},
