Game.grade1_3Alevel1=function(){};


Game.grade1_3Alevel1.prototype={
    ...
    init:function(game)
    {
        ...
        telInitializer.gameIdInit("pinwheel1_3A",gradeSelected);
        

    },

    preload:function(game){
        if(!window.grade3NSF2){

            window.grade3NSF2 = true;
  ...
  return array;
    ...
    addQuestion:function(no2)
    {
       /* //console.log(_this.no2);
        ...
        var lineAnim2 = _this.add.sprite(_this.world.centerX,-20,'Level13A_headingLine');
        lineAnim2.anchor.setTo(0.5);
        lineAnim2.scale.setTo(1.041,1);
        text = _this.add.text(0, 5,'Level13A_  Colour 1/4th part of the whole  ');
        text.anchor.set(0.5);
        text.align = 'center';
        ...
        text.setShadow(0, 0,'Level13A_rgba(0, 0, 0, 0)', 0);
...
//                            case 14:text.setText(selctedLang.lastSceneQuestion14);break;
    ...
    gotoFirstQuestion:function(){
    	_this.no11++;
    	_this.mainFlag = _this.add.sprite(270,230,'Level13A_flagmain11');
    	_this.mainFlag.anchor.setTo(0.5);
    	_this.opt1 = _this.add.sprite(570,280,'Level13A_Ans1');
    	_this.opt1.anchor.setTo(0.5);
        _this.opt1.name = 'right_this.Answer';
    	_this.opt2 = _this.add.sprite(730,280,'Level13A_Ans2');
    	_this.opt2.anchor.setTo(0.5);
    	
    	_this.opt3 = _this.add.sprite(890,280,'Level13A_Ans3');
    ...
    gotoSecondQuestion:function(){
    	...
    	_this.no11++;
    	_this.mainFlag = _this.add.sprite(270,280,'Level13A_flagmain12');
    	_this.mainFlag.anchor.setTo(0.5);
    	_this.opt1 = _this.add.sprite(585,280,'Level13A_Ans21');
    	_this.opt1.anchor.setTo(0.5);
    	_this.opt2 = _this.add.sprite(755,280,'Level13A_Ans22');
    	_this.opt2.anchor.setTo(0.5);
    _this.opt2.name = 'right_this.Answer';
    	_this.opt3 = _this.add.sprite(890,280,'Level13A_Ans32');
    	_this.opt3.anchor.setTo(0.5);
    ...
    gotoThirdQuestion:function(){
    		...
    		_this.no11++;
    	_this.mainFlag = _this.add.sprite(270,290,'Level13A_flagmain51');
    	_this.mainFlag.anchor.setTo(0.5);
    	_this.opt1 = _this.add.sprite(570,280,'Level13A_Ans51');
    	_this.opt1.anchor.setTo(0.5);
    	  _this.opt1.name = 'right_this.Answer';
    
    	_this.opt2 = _this.add.sprite(730,280,'Level13A_Ans52');
    	_this.opt2.anchor.setTo(0.5);
          
    	
    	_this.opt3 = _this.add.sprite(880,280,'Level13A_Ans53');
    	_this.opt3.anchor.setTo(0.5);
    ...
    gotoFourthQuestion:function(){
    	...
    	_this.rno11++;
    	_this.mainFlag = _this.add.sprite(270,260,'Level13A_flagmain41');
    	_this.mainFlag.anchor.setTo(0.5);
    	_this.opt1 = _this.add.sprite(545,280,'Level13A_Ans41');
    	_this.opt1.anchor.setTo(0.5);
    
    	_this.opt2 = _this.add.sprite(665,280,'Level13A_Ans42');
    	_this.opt2.anchor.setTo(0.5);
    	
    	_this.opt3 = _this.add.sprite(865,280,'Level13A_Ans43');
    	_this.opt3.anchor.setTo(0.5);
    ...
    _this.rno11++;
    	_this.mainFlag = _this.add.sprite(270,260,'Level13A_flagmain31');
    	_this.mainFlag.anchor.setTo(0.5);
    	_this.opt1 = _this.add.sprite(585,280,'Level13A_Ans31');
    	_this.opt1.anchor.setTo(0.5);
    	_this.opt2 = _this.add.sprite(740,280,'Level13A_Ans23');
    	_this.opt2.anchor.setTo(0.5);
            _this.opt2.name = 'right_this.Answer';
    	_this.opt3 = _this.add.sprite(890,280,'Level13A_Ans33');
    	_this.opt3.anchor.setTo(0.5);
    ...
    gotoSixthQuestion:function(){
    	...
    	_this.vno11++;
    	_this.mainFlag = _this.add.sprite(270,270,'Level13A_flagmain61');
    	_this.mainFlag.anchor.setTo(0.5);
    	_this.opt1 = _this.add.sprite(570,280,'Level13A_Ans61');
    	_this.opt1.anchor.setTo(0.5);
    	
    
    	_this.opt2 = _this.add.sprite(720,280,'Level13A_Ans62');
    	_this.opt2.anchor.setTo(0.5);
    	
    	_this.opt3 = _this.add.sprite(880,280,'Level13A_Ans63');
    	_this.opt3.anchor.setTo(0.5);
        _this.opt3.name = 'right_this.Answer';
	...
	changeQuestion:function()
	{
		...
		else
		{
			//console.log("gameEnd");
				...
				// text = _this.add.text(_this.world.centerX, 450,'Level13A_  Game Complete  ');
				...
				// text.setShadow(0, 0,'Level13A_rgba(0, 0, 0, 0.5)', 0);
            

    
       /*     // _this.no1++;
    	_this.b1 = _this.add.sprite(300,300,'Level13A_flagmain31');
    	_this.b1.anchor.setTo(0.5);
    	_this.b2 = _this.add.sprite(620,300,'Level13A_Ans31');
    	_this.b2.anchor.setTo(0.5);
    	_this.b3 = _this.add.sprite(770,300,'Level13A_Ans23');
    	_this.b3.anchor.setTo(0.5);
            _this.b3.name = 'right_this.Answer';
    	_this.b4 = _this.add.sprite(920,300,'Level13A_Ans33');
    	_this.b4.anchor.setTo(0.5);
        ...
        else
        {
            ...
            _this.addListeners();
             ...
             _this.state.start('grade1_3AScore');
//   baudio.stop();
...
//timer.setText(minutes + ':'+ seconds );
	...
	correctAns1:function(target)
	{
		...
		//_this.celebAnim1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height,'Level13A_celeb');
