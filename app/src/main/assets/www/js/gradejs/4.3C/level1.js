         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            ...
            mlTxt4.fill = '#373535';
                ...
                mlTxt = this.add.text(245,295, "એમ ");
				mlTxt.font = 'Comic Sans MS';
				mlTxt.fontSize = 10;
                mlTxt.fill = '#373535'; 
                ...
                mlTxt2 = this.add.text(480,335, "લિટર ");
				mlTxt2.font = 'Comic Sans MS';
				mlTxt2.fontSize = 12;
                mlTxt2.fill = '#373535'; 
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            ...
            mlTxt4.fill = '#373535';
				...
				kgTxt = this.add.text(646,378, "એમ ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
               
                mlTxt = this.add.text(248,390, "એમ ");
				mlTxt.font = 'Comic Sans MS';
				mlTxt.fontSize = 10;
                mlTxt.fill = '#373535'; 
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            ...
            mlTxt4.fill = '#373535';
				...
				kgTxt = this.add.text(654,281, "એમ ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
             
                mlTxt = this.add.text(248,340, "એમ ");
				mlTxt.font = 'Comic Sans MS';
				mlTxt.fontSize = 10;
                mlTxt.fill = '#373535'; 
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            ...
            mlTxt4.fill = '#373535';
				...
				kgTxt = this.add.text(650,246, "એમ ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
                mlTxt = this.add.text(248,370, "એમ ");
				mlTxt.font = 'Comic Sans MS';
				mlTxt.fontSize = 10;
                mlTxt.fill = '#373535'; 
         ...
         b6.name = "arrowC";
		  ...
		  if(window.languageSelected=="English"){
            ...
            mlTxt4.fill = '#373535';
				...
				kgTxt = this.add.text(658,210, "એમ ");
				kgTxt.font = 'Comic Sans MS';
				kgTxt.fontSize = 13;
             
                mlTxt = this.add.text(248,295, "એમ ");
				mlTxt.font = 'Comic Sans MS';
				mlTxt.fontSize = 10;
                mlTxt.fill = '#373535'; 
