Game.addition_NOAG_3_2level1=function(){};

Game.addition_NOAG_3_2level1.prototype={
    ...
    create:function(game){
        ...
        this.video.changeSource(window.baseUrl+"assets/demoVideos/7_1_2.mp4");
	...
	create1:function(game){
	   ...
	   _this.eraserclicked=0;
        ...
        if(window.languageSelected == "English")
                {
                   _this.soundurl =  window.baseUrl+"questionSounds/7.2.2/English/Game 7.1.2.mp3";
                }
                else if(window.languageSelected == "Hindi")
                {
                    _this.soundurl =  window.baseUrl+"questionSounds/7.2.2/Hindi/Game 7.1.2.mp3";
                }
                else if(window.languageSelected=="Kannada")
                {
                    _this.soundurl =  window.baseUrl+"questionSounds/7.2.2/Kannada/Game 7.1.2.mp3";
                }
                ...
                {
                    _this.soundurl =  window.baseUrl+"questionSounds/7.2.2/Odiya/7.1.2.mp3";
             ...
             this.hintparams=['NOAG32','level1',false,false,true,1];
              commonNavBar.addHint(this,this.hintparams);
        
        
        _this.coinPannel = _this.add.sprite(70,50,'Level722_coinMachinePannel1');
       // _this.Pannel = _this.add.sprite(628,105,'Level722_pannel1');
        _this.Pannel = _this.add.sprite(625,105,'Level722_pannel1');
        
        _this.LeverGreen = _this.add.sprite(140,60,'Level722_LeverGreen');
         _this.LeverGreen.name = "LeverGreen";
        _this.LeverBlue = _this.add.sprite(300,60,'Level722_LeverBlue');
         _this.LeverBlue.name ="LeverBlue";
        _this.LeverYellow = _this.add.sprite(465,60,'Level722_LeverYellow');
        _this.LeverYellow.name = "LeverYellow";
        
        _this.Levercoin1 = _this.add.sprite(485,160,'Level722_coin1Anim');
        _this.Levercoin1.visible = false;
        
      _this.Levercoin10 = _this.add.sprite(315,168,'Level722_coin10Anim');
        _this.Levercoin10.visible = false; 

        _this.Level722_OneToHundred1 = _this.add.sprite(152,63,'Level722_OneToHundred');
        _this.Level722_OneToHundred10 = _this.add.sprite(315,63,'Level722_OneToHundred');
        _this.Level722_OneToHundred10.frame = 1;
        _this.Level722_OneToHundred100 = _this.add.sprite(478,63,'Level722_OneToHundred');
        _this.Level722_OneToHundred100.frame = 2;
		
		_this.Level722_OneToHundredE1 = _this.add.sprite(665,95,'Level722_OneToHundred');
        _this.Level722_OneToHundredE10 = _this.add.sprite(735,95,'Level722_OneToHundred');
        _this.Level722_OneToHundredE10.frame = 1;
        _this.Level722_OneToHundredE100 = _this.add.sprite(810,95,'Level722_OneToHundred');
        _this.Level722_OneToHundredE100.frame = 2;
        
        
        _this.LeverBlueNumber = _this.add.sprite(152,83,'Level722_numberSmall');
         _this.LeverBlueNumber.frame = 1;
        _this.LeverGreenNumber = _this.add.sprite(315,83,'Level722_numberSmall');
        _this.LeverGreenNumber.frame = 1;
        _this.LeverYellowNumber = _this.add.sprite(478,83,'Level722_numberSmall');
        _this.LeverYellowNumber.frame = 1;
        
        _this.shakeGroup = _this.add.group();
         _this.numBox1 = _this.add.sprite(650,278,'Level722_numberBox');
         ...
         _this.numBox2 = _this.add.sprite(719,278,'Level722_numberBox');
         ...
         _this.numBox3 = _this.add.sprite(790,278,'Level722_numberBox');
        ...
        //_this.plusSign = _this.add.sprite(610,200,'Level722_plusSign');
        _this.plusSign = _this.add.sprite(610,200,'Level722_plusSign');
    ...
    coinDisplay:function(){
        _this.yellowcoin=this.add.sprite(475,210,'Level722_Coin1');
        _this.yellowcoin.visible=true;
        _this.Coin1 = _this.add.sprite(0,0,'Level722_Coin1');
        _this.Coin1.visible = false;
        _this.bluecoin=this.add.sprite(310,210,'Level722_Coin10');
        _this.bluecoin.visible=true;
        _this.Coin10 = _this.add.sprite(310,210,'Level722_Coin10');
    ...
    {  ////console.log("get Question "+_this.no1);
      ...
      _this.askNumber1 = _this.add.sprite(795,120,'Level722_numberSmall');
         //_this.askNumber1.frame = 1;
         _this.askNumber1.scale.setTo(1.3,1.3);
        
        
        _this.askNumber2 = _this.add.sprite(795,190,'Level722_numberSmall');
        //_this.askNumber2.frame = 1;
         _this.askNumber2.scale.setTo(1.3,1.3);
        
        _this.askNumber3 = _this.add.sprite(725,120,'Level722_numberSmall');
        // _this.askNumber3.frame = 1;
         _this.askNumber3.scale.setTo(1.3,1.3);
        
        _this.askNumber4 = _this.add.sprite(725,190,'Level722_numberSmall');
  ...
  inputDownFunctionForLeverAndBox :function(){
      ...
      _this.Coin1 = _this.add.sprite(475,210,'Level722_Coin1');
      _this.Coin1.visible = false;
      _this.Coin10 = _this.add.sprite(310,220,'Level722_Coin10');
      _this.Coin10.visible = false;
      //_this.Coin1.frame=7;
    ...
    leve1Clicked:function(target,frame){
        ...
        if(target.name == "LeverYellow"){
            ...
            if(_this.YellowAnimInc<_this.displayNumber2){
              _this.LeverYellow.animations.add('Level722_LeverYellow',[0,1,2,3,4,0]);
        ...
        if(target.name == "LeverBlue"){
            ...
            if(_this.BlueAnimInc<_this.displayNumber4){
                ...
                _this.LeverBlue.animations.add('Level722_LeverBlue',[0,1,2,3,4,0]);
    ...
    glowAnim:function(){
     ...
     numClicked:function(target){
        ...
        if(_this.numBox2Pressed){
            ...
            //  if( (_this.eraserclicked == 1) && (_this.numBox3Pressed)){
            //       console.log("HERE");
            //       _this.numBox2.frame = 1;
            //       _this.numBox3.frame = 0;
            ...
            //     }
            //  console.log(_this.selectedAns3);
            // console.log(_this.eraserclicked);
            // console.log(_this.numBox3Pressed);
  ...
  return array;
				...
				_this.skipDemos.events.onInputDown.add(function(){
					_this.skipDemos.destroy();
					 ...
					 this.videoLevel2.onComplete.removeAll();
						 _this.state.start('addition_NOAG_3_2level2',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
					},_this);
		  ...
		  _this.src = document.createElement('source');
            switch( _this.qArrays[ _this.no1])
            {
                ...
                case 15:if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/7.2.2/English/Game 7.1.2.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/7.2.2/Hindi/Game 7.1.2.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/7.2.2/Kannada/Game 7.1.2.mp3");
                        }
						else
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/7.2.2/Odiya/7.1.2.mp3");
							_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                        }
                        break;
            }
    ...
    shutdown:function(){
        ...
        delete _this.Level722_OneToHundred1;
        delete _this.Level722_OneToHundred10;
        delete _this.Level722_OneToHundred100;
