...
Game.addition_NOAG_3_2level2.prototype={
  ...
  inputDownFunctionForLeverAndBox:function(){
      ...
      _this.Coin100 = _this.add.sprite(153,210,'Level723_Coin100');//330,145
     ...
     //  _this.numBox3.input.useHandCursor = true;
      ...
      _this.Level721_OneToHundred1 = _this.add.sprite(124,70,'Level722_OneToHundred');
	        _this.Level721_OneToHundred10 = _this.add.sprite(304,70,'Level722_OneToHundred');//304,55
	        _this.Level721_OneToHundred10.frame = 1;
	        _this.Level721_OneToHundred100 = _this.add.sprite(484,70,'Level722_OneToHundred');
	        _this.Level721_OneToHundred100.frame = 2;
			
			_this.Level321_OneToHundredE1 = _this.add.sprite(665,120,'Level722_OneToHundred');
	        _this.Level321_OneToHundredE1.scale.setTo(0.8,0.8);
	        _this.Level321_OneToHundredE10 = _this.add.sprite(735,120,'Level722_OneToHundred');
	        _this.Level321_OneToHundredE10.scale.setTo(0.8,0.8);
	        _this.Level321_OneToHundredE10.frame = 1;
	        _this.Level321_OneToHundredE100 = _this.add.sprite(800,120,'Level722_OneToHundred');
...
generateStarsForScoreScene:function(game,count)
    ...
    shutdown:function(){
         commonNavBar.stopVoice();
            ...
            {
                localStorage.setItem("addition_NOAG_3_2state", "playedwithhint");
                localStorage.setItem("numberoperationPlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                localStorage.setItem("addition_NOAG_3_2state", "fullycomplete");
