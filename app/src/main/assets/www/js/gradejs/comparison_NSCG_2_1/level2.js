Game.comparison_NSCG_2_1level2=function(){
};
Game.comparison_NSCG_2_1level2.prototype={
...
//        _this.wrongflag=0;
		...
		//_this.soundurl = "questionSounds/4.5.1/English/Game 4.5.1.mp3";
        ...
        this.hintparams=['NSCG2.1','level2',false,true,true,2];
...
getboyToUp:function()
    ...
    gotoFirstQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=7;
		 _this.numBox21.value=4;
		  _this.numBox31.value=1;
		  _this.numBox41.value=2;
		   _this.numBox51.value=9;

        _this.rightorder=[9,7,4,2,1];
        ...
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(23,-7.5,'4');
        ...
        _this.number3 = _this.add.text(26,-7.5,'1');
    ...
    gotoSecondQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=7;
		 _this.numBox21.value=6;
		  _this.numBox31.value=2;
		  _this.numBox41.value=4;
		   _this.numBox51.value=9;

        _this.boxBlink();
        _this.rightorder=[9,7,6,4,2];
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number1 = _this.add.text(23,-7.5,'7');
        //_this.number1.anchor.setTo(0.5,0.5);
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(23,-7.5,'6');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
    ...
    gotoThirdQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=17;
		 _this.numBox21.value=14;
		  _this.numBox31.value=10;
		  _this.numBox41.value=12;
		   _this.numBox51.value=19;
        //_this.UnorderedNum1.add(_this.numBox11);
        //_this.UnorderedNum1.add(_this.numBox11);
        _this.boxBlink();
        _this.rightorder=[19,17,14,12,10];
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number1 = _this.add.text(20,-7.5,'17');
        //_this.number1.anchor.setTo(0.5,0.5);
        _this.number1.align = 'center';
        _this.number1.font = 'myfont';
        _this.number1.fontWeight = 'normal';
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(20,-7.5,'14');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number4 = _this.add.text(20,-7.5,'12');
        //_this.number4.anchor.setTo(2);
        _this.number4.align = 'center';
        _this.number4.font = 'myfont';
        _this.number4.fontWeight = 'normal';
    ...
    gotoFourthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=19;
		 _this.numBox21.value=16;
		  _this.numBox31.value=10;
		  _this.numBox41.value=11;
		   _this.numBox51.value=24;
        _this.rightorder=[24,19,16,11,10];
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(22.5,-7.5,'16');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number3 = _this.add.text(21,-7.5,'10');
        //_this.number3.anchor.setTo(2);
        _this.number3.align = 'center';
        _this.number3.font = 'myfont';
        _this.number3.fontWeight = 'normal';
        ...
        _this.number4 = _this.add.text(23,-7.5,'11');
        //_this.number4.anchor.setTo(2);
        _this.number4.align = 'center';
        _this.number4.font = 'myfont';
        _this.number4.fontWeight = 'normal';
        ...
        _this.number4.fill = '#127E8A';
        _this.numBox41.addChild(_this.number4);
        _this.number5 = _this.add.text(17,-7.5,'24');
        //_this.number5.anchor.setTo(2);
        _this.number5.align = 'center';
        _this.number5.font = 'myfont';
        _this.number5.fontWeight = 'normal';
    ...
    gotoFifthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=7;
		 _this.numBox21.value=5;
		  _this.numBox31.value=1;
		  _this.numBox41.value=3;
		   _this.numBox51.value=9;
        _this.rightorder=[9,7,5,3,1];
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoSixthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=10;
		 _this.numBox21.value=8;
		  _this.numBox31.value=2;
		  _this.numBox41.value=5;
		   _this.numBox51.value=13;
        _this.rightorder=[13,10,8,5,2];
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(23,-7.5,'8');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number4.fill = '#127E8A';
        _this.numBox41.addChild(_this.number4);
        _this.number5 = _this.add.text(22,-7.5,'13');
        //_this.number5.anchor.setTo(2);
        _this.number5.align = 'center';
        _this.number5.font = 'myfont';
        _this.number5.fontWeight = 'normal';
    ...
    gotoSeventhQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=19;
		 _this.numBox21.value=15;
		  _this.numBox31.value=7;
		  _this.numBox41.value=11;
		   _this.numBox51.value=23;
        _this.rightorder=[23,19,15,11,7];
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(23,-7.5,'15');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number3 = _this.add.text(21.5,-7.5,'7');
        //_this.number3.anchor.setTo(2);
        _this.number3.align = 'center';
        _this.number3.font = 'myfont';
        _this.number3.fontWeight = 'normal';
        ...
        _this.number4.fill = '#127E8A';
        _this.numBox41.addChild(_this.number4);
        _this.number5 = _this.add.text(21,-7.5,'23');
        //_this.number5.anchor.setTo(2);
        _this.number5.align = 'center';
        _this.number5.font = 'myfont';
        _this.number5.fontWeight = 'normal';
    ...
    gotoEighthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=25;
		 _this.numBox21.value=22;
		  _this.numBox31.value=10;
		  _this.numBox41.value=15;
		   _this.numBox51.value=39;

        _this.rightorder=[39,25,22,15,10];
        _this.number1 = _this.add.text(17,-7.5,'25');
        //_this.number1.anchor.setTo(0.5,0.5);
        _this.number1.align = 'center';
        _this.number1.font = 'myfont';
        _this.number1.fontWeight = 'normal';
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(17,-7.5,'22');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number3 = _this.add.text(19,-7.5,'10');
        //_this.number3.anchor.setTo(2);
        _this.number3.align = 'center';
        _this.number3.font = 'myfont';
        _this.number3.fontWeight = 'normal';
        ...
        _this.number4.fill = '#127E8A';
        _this.numBox41.addChild(_this.number4);
        _this.number5 = _this.add.text(17,-7.5,'39');
        //_this.number5.anchor.setTo(2);
        _this.number5.align = 'center';
        _this.number5.font = 'myfont';
        _this.number5.fontWeight = 'normal';
    ...
    gotoNinthQuestion:function(){
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=27;
		 _this.numBox21.value=20;
		  _this.numBox31.value=11;
		  _this.numBox41.value=16;
		   _this.numBox51.value=48;

        _this.rightorder=[48,27,20,16,11];
        _this.number1 = _this.add.text(18,-7.5,'27');
        //_this.number1.anchor.setTo(0.5,0.5);
        _this.number1.align = 'center';
        _this.number1.font = 'myfont';
        _this.number1.fontWeight = 'normal';
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(18,-7.5,'20');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number3 = _this.add.text(18,-7.5,'11');
        //_this.number3.anchor.setTo(2);
        _this.number3.align = 'center';
        _this.number3.font = 'myfont';
        _this.number3.fontWeight = 'normal';
        ...
        _this.number4 = _this.add.text(18,-7.5,'16');
        //_this.number4.anchor.setTo(2);
        _this.number4.align = 'center';
        _this.number4.font = 'myfont';
        _this.number4.fontWeight = 'normal';
        ...
        _this.number4.fill = '#127E8A';
        _this.numBox41.addChild(_this.number4);
        _this.number5 = _this.add.text(18,-7.5,'48');
        //_this.number5.anchor.setTo(2);
        _this.number5.align = 'center';
        _this.number5.font = 'myfont';
        _this.number5.fontWeight = 'normal';
    ...
    gotoTenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=18;
		 _this.numBox21.value=16;
		  _this.numBox31.value=12;
		  _this.numBox41.value=14;
		   _this.numBox51.value=20;
        _this.rightorder=[20,18,16,14,12];//19,18,16,17,20
        _this.number1 = _this.add.text(19.5,-7.5,'18');
        //_this.number1.anchor.setTo(0.5,0.5);
        _this.number1.align = 'center';
        _this.number1.font = 'myfont';
        _this.number1.fontWeight = 'normal';
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(16,-7.5,'16');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
        ...
        _this.number3 = _this.add.text(16,-7.5,'12');
        //_this.number3.anchor.setTo(2);
        _this.number3.align = 'center';
        _this.number3.font = 'myfont';
        _this.number3.fontWeight = 'normal';
        ...
        _this.number4 = _this.add.text(18,-7.5,'14');
        //_this.number4.anchor.setTo(2);
        _this.number4.align = 'center';
        _this.number4.font = 'myfont';
        _this.number4.fontWeight = 'normal';
        ...
        _this.number4.fill = '#127E8A';
        _this.numBox41.addChild(_this.number4);
        _this.number5 = _this.add.text(15,-7.5,'20');
        //_this.number5.anchor.setTo(2);
        _this.number5.align = 'center';
        _this.number5.font = 'myfont';
        _this.number5.fontWeight = 'normal';
    ...
    gotoEleventhQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=7;
		 _this.numBox21.value=6;
		  _this.numBox31.value=4;
		  _this.numBox41.value=5;
		   _this.numBox51.value=8;

        _this.rightorder=[8,7,6,5,4];//7,6,4,5,8
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    gotoTwelvethQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=16;
		 _this.numBox21.value=15;
		  _this.numBox31.value=13;
		  _this.numBox41.value=14;
		   _this.numBox51.value=17;

        _this.rightorder=[17,16,15,14,13];//16,15,13,14,17
    ...
    gotoThirteenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=11;
		 _this.numBox21.value=10;
		  _this.numBox31.value=8;
		  _this.numBox41.value=9;
		   _this.numBox51.value=12;
        _this.rightorder=[12,11,10,9,8];//11,10,8,9,12
        //_this.UnorderedNum1.add(_this.numBox11);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        ...
        _this.numBox11.addChild(_this.number1);
        //console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
        _this.number2 = _this.add.text(20,-7.5,'10');
        // _this.number2.anchor.setTo(2);
        _this.number2.align = 'center';
        _this.number2.font = 'myfont';
        _this.number2.fontWeight = 'normal';
    ...
    gotoFourteenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=9;
		 _this.numBox21.value=8;
		  _this.numBox31.value=6;
		  _this.numBox41.value=7;
		   _this.numBox51.value=10;

        _this.rightorder=[10,9,8,7,6];//9,8,6,7,10
    ...
    gotoFifteenthQuestion:function(){ 
       ...
       _this.numBox11.xpos=211;
		...
		_this.numBox11.value=5;
		 _this.numBox21.value=4;
		  _this.numBox31.value=2;
		  _this.numBox41.value=3;
		   _this.numBox51.value=6;

        _this.rightorder=[6,5,4,3,2];//5,4,2,3,6
    ...
    replayClicked:function()
    {
        ...
        this.time.events.add(3000, function()
            ...
            commonNavBar.soundVar=null,
                ...
                _this.state.start('comparison_NSCG_2_1level1',true,false);
        }, this);
    },
       ...
       _this.stopVoice();
        ...
        window.score += commonNavBar.deductForHint;
            ...
            if(this.playedwithHint&&this.completelyplayed)
            {
                ...
                localStorage.setItem(window.avatarName+"comparison_NSCG_2_1state", "playedwithhint");
                localStorage.setItem(window.avatarName+"numbersensePlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                telInitializer2.syncToServer();
                localStorage.setItem(window.avatarName+"comparison_NSCG_2_1state", "fullycomplete");
                localStorage.setItem(window.avatarName+"comparison_NSCG_4_2state", "canplay");
                localStorage.setItem(window.avatarName+"numbersensePlayed", "played");
            }   
