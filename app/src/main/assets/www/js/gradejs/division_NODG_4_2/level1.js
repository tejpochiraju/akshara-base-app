Game.division_NODG_4_2level1=function(){};
var randarr;
var numGroup;
var showNum1;
var showNum2;
...
Game.division_NODG_4_2level1.prototype={
     ...
     init:function(game)
    {
        ...
        telInitializer2.gameIdInit2("NODG4.2");
	...
	create:function(game){
        ...
        if(window.languageSelected == "English")
                        {
                           _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/English/Game 17.2.mp3";
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/Hindi/Game 17.2.mp3";
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                             _this.qsoundurl= window.baseUrl+"questionSounds/3.2.1/Kannada/Game 17.2.mp3";
                        }
       ...
       // commonNavBar.addHint(this);
        this.hintparams=['NODG4.2','level1',false,true,true,2];
                   ...
                   if (this.checkOverlap(target,wronggraphics1))
                     ...
                     if(_this.displayNumber1==3&&(w<8)&&done==1)
                           ...
                           // hhh++;
                            ...
                            if(showNum1==1&&showNum2==1)
                                {
                                   console.log('number2'); _this.addNumberPad();
                                }
             ...
             if(target.name=="yellow")
               {
                   ...
                   if (this.checkOverlap(target,wronggraphics1))
                    ...
                    //console.log("n21="+(Number(_this.assign2)-1));
                            ...
                            {
                               console.log('number3'); _this.addNumberPad();
                            }
                        ...
                        //console.log("no1="+(Number(_this.assign1)-1));
                            ...
                            if(showNum1==1&&showNum2==1&&showNum3==1)
                            {
                                console.log('number4'); _this.addNumberPad();
                            }
                   ...
                   else if (this.checkOverlap(target,wronggraphics3))
                        {
                            ...
                            if(showNum1==1&&showNum2==1&&showNum3==1)
                            {
                               console.log('number5'); _this.addNumberPad();
                            }
                        }
                   ...
                   if (this.checkOverlap(target,wronggraphics1))
                        {
                            ...
                            if(showNum1==1&&showNum2==1&&showNum3==1&&showNum4==1)
                                {
                                  console.log('number6');  _this.addNumberPad();
                                }
                      ...
                      else if (this.checkOverlap(target,wronggraphics2))
                        {
                            ...
                            if(_this.displayNumber1==8&&_this.displayNumber2==8)
                             ...
                             if(showNum1==1&&showNum2==1&&showNum3==1&&showNum4==1)
                                {
                                    console.log('number7'); _this.addNumberPad();
                                }
                   ...
                   else if (this.checkOverlap(target,wronggraphics3))
                        {
                            ...
                            if(_this.displayNumber1==8&&_this.displayNumber2==8)
                             ...
                             if(showNum1==1&&showNum2==1&&showNum3==1&&showNum4==1)
                                {
                                    console.log('number8'); _this.addNumberPad();
                                }
                   ...
                   else if (this.checkOverlap(target,wronggraphics4))
                        {
                            ...
                            if(_this.displayNumber1==8&&_this.displayNumber2==8)
                             ...
                             if(showNum1==1&&showNum2==1&&showNum3==1&&showNum4==1)
                                {
                                    console.log('number9'); _this.addNumberPad();
                                }
  ...
  addYellowCoins:function(){
    ...
    addNumberPad:function(){
       ...
       // _this.slideup();
        ...
        wrongbtn.events.onInputDown.add(function(){commonNavBar.playClickSound();wrongbtn.frame = 1;enterTxt.setText("");selectedAns="";
     ...
     showNum4=0;
            ...
            selectedAns = '';
             var timerStopVar = commonNavBar.stopTimer();
               ...
               _this.state.start('division_NODG_4_2level2',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
