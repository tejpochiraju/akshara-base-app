Game.length_MLG_3_2level1=function(){
 /*bg1;
 starsGroup;
 dragBox;
 count;
...
_this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level24A_bg1');
  ...
  return array;
	...
	*/
        ...
        else
        {
            console.log("--------------------------------------------------");
             ...
             commonNavBar.stopVoice();
              ...
              _this.state.start('length_MLG_3_2level2',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
    ...
    addNumberPad:function(){
        ...
        var wrongbtn = numGroup.create(x+100,505,'Level24A_wrongBtn');
        ...
        var rightbtn = numGroup.create(x+160,505,'Level24A_rightBtn');
   ...
   /* getVoice:function(question){
    ...
    {   
         ...
         switch(question)
        {
            ...
            case 18:if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/English/2.4B1.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/Hindi/2.4B1.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
