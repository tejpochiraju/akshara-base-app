Game.length_MLG_3_2level2=function(){
    /* bg1;
     starsGroup;
     dragBox;
     count;
...
Game.length_MLG_3_2level2.prototype={
    ...
    init:function(param,score,timerStopVar)
    {
        ...
        this.Stararr = param;
          this.score = score;
          _this.background = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level24B_bg1');
...
*/
    ...
    removeEverthing:function() 
    {
        ...
        if(no1<4)
        {
           ...
           _this.starsGroup.getChildAt(count1).frame = 2; 
  ...
  if((this.scoreSceneScore/this.maxscore) < 0.4){
    ...
    replayClicked:function()
    {
        ...
        { 
            ...
            _this.state.start('length_MLG_3_2level1',true,false);
             },this);
        }, this);
    },
    ...
    addNumberPad:function(){
        ...
        for(var i=0;i<10;i++)
        {
            var numbg = numGroup.create(x,505,'Level24A_Number'); 
        ...
        if(no1<=2)
            ...
            else if(window.languageSelected=="Odiya")
            {
                ...
                {
                    var gmTxt2 = this.add.text(x+65,510, "સેમી");
                    gmTxt2.anchor.setTo(0.5);
                    gmTxt2.align = 'center';
            ...
            if(window.languageSelected=="English")
                {
                    ...
                    gmTxt.align = 'center';
                    gmTxt.name = 'm';
                    console.log("gmTxt.name"+gmTxt.name);
                    gmTxt.font = 'myfont';
                    gmTxt.fontSize = 30;
                    gmTxt.fontWeight = 'normal';
                    gmTxt.fill = '#65B4C3';
                ...
                var gmTxt2 = this.add.text(x+65,510, "મી");
                    gmTxt2.anchor.setTo(0.5);
                    gmTxt2.align = 'center';
                     gmTxt2.font = 'myfont';
                    gmTxt2.fontSize = 20;
    ...
    gotoFirstQuestion:function(){
       ...
       // console.log(target.x);
        ...
        tape15cm.events.onDragStop.add(function(target){            commonNavBar.playSnapSound();
    ...
    gotoThirdQuestion:function(){
      ...
      /*  if(window.languageSelected=="English")
                {
                    var gmTxt = this.add.text(800,505, "cm");
                    gmTxt.anchor.setTo(0.5);
                    gmTxt.align = 'center';
                ...
                {
                    var gmTxt1 = this.add.text(this.x+60,510, "सें.मी");
                    gmTxt1.anchor.setTo(0.5);
                    gmTxt1.align = 'center';
                ...
                {
                    var gmTxt2 = this.add.text(this.x+65,510, "ಸೆಂ.ಮೀ"); 
                    gmTxt2.anchor.setTo(0.5);
                    gmTxt2.align = 'center';
            ...
            {
                var gmTxt2 = this.add.text(this.x+65,510, "ସେ.ମୀ");
                    gmTxt2.anchor.setTo(0.5);
                    gmTxt2.align = 'center';
    ...
    gotoFifthQuestion:function(){
        ...
        //this.getVoice(5);
         ...
         /*if(window.languageSelected=="English")
                {
                    var gmTxt = this.add.text(this.x+60,505, "m");
                    gmTxt.anchor.setTo(0.5);
                    gmTxt.align = 'center';
                    gmTxt.name = 'm';
                    console.log("gmTxt.name"+gmTxt.name);
                ...
                {
                    var gmTxt1 = this.add.text(this.x+60,510, "मी");
                    gmTxt1.anchor.setTo(0.5);
                    gmTxt1.align = 'center';
                ...
                {
                    var gmTxt2 = this.add.text(this.x+65,510, "ಮೀ"); 
                    gmTxt2.anchor.setTo(0.5);
                    gmTxt2.align = 'center';
                ...
                var gmTxt2 = this.add.text(this.x+65,510, "ମୀ");
                    gmTxt2.anchor.setTo(0.5);
                    gmTxt2.align = 'center';
                     gmTxt2.font = 'myfont';
                    gmTxt2.fontSize = 20;
        ...
        popup2=this.add.sprite(480,62,'game24b_popup2');
        popup2.anchor.setTo(0.5);
        if(window.languageSelected=="English")
                        popup2.frame=0;
                    else if(window.languageSelected=="Hindi")
    ...
    {   
         ...
         switch(question)
        {
            ...
            case 3:
                    if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/English/2.4A1.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/Hindi/2.4A1.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
            ...
            case 16:
                    if(window.languageSelected == "English")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/English/2.4A2.mp3");
                        }
                        else if(window.languageSelected == "Hindi")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/Hindi/2.4A2.mp3");
                        }
                        else if(window.languageSelected == "Kannada")
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/Kannada/2.4A2.mp3");
                        }
                        else if(window.languageSelected == "Gujarati")
                        {
                        ...
                        {
                            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.4A/Odiya/2.4A2.mp3");
                            _this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                        }
                        break;
    ...
    shutdown:function()
    {
       ...
       /* delete bg1;
        ...
        if(this.playedwithHint&&this.completelyplayed)
        {
            ...
            localStorage.setItem(window.avatarName+"length_MLG_3_2state", "playedwithhint");
            localStorage.setItem(window.avatarName+"measurementPlayed", "played");
        }
        else if(!this.playedwithHint&&this.completelyplayed)
        {
            telInitializer2.syncToServer();
            localStorage.setItem(window.avatarName+"length_MLG_3_2state", "fullycomplete");
            localStorage.setItem(window.avatarName+"measurementPlayed", "played");
        }
