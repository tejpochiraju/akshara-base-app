Game.multiplication_NOMG_2_1level1=function(){};
...
Game.multiplication_NOMG_2_1level1.prototype ={
    ...
    init:function(game)
    {
       ...
       telInitializer2.gameIdInit2("NOMG2.1");
	...
	create:function(game)
    {
        ...
        if(window.languageSelected=="English")
                         _this.qsoundurl =window.baseUrl+"questionSounds/12.3.1/English/12.3.1.mp3";
                    else if(window.languageSelected=="Hindi")
                        _this.qsoundurl =window.baseUrl+"questionSounds/12.3.1/Hindi/12.3.1.mp3";
                    else if(window.languageSelected=="Kannada")
                        _this.qsoundurl =window.baseUrl+"questionSounds/12.3.1/Kannada/12.3.1.mp3";
                    else if(window.languageSelected=="Gujarati")
                        _this.qsoundurl =window.baseUrl+"questionSounds/Gujarati/12.1/12.1.mp3";
                    else
                        _this.qsoundurl =window.baseUrl+"questionSounds/12.3.1/Odiya/12.3.1.mp3";
        ...
        this.hintparams=['NOMG2.1','level1',false,true,true,2];
        ...
        target.events.onDragStop.add(function(target)
        {
            ...
            { 
                ...
                if(_this.randomno==5)
                {
                    ...
                    _this.FirstNumbers1.frame = _this.randomno-1;//_this.randomno;
...
//                     }
	 ...
	 shuffleNumbers:function()
    {
       console.log("shuffleNumbers");
        ...
        _this.framesChange = [2,3,4,5];
        _this.framesChange = this.shuffle(_this.framesChange);

        _this.FirstNumbers = this.add.sprite(_this.world.centerX+160,_this.world.centerY-143,'Unity12_3_1greenNumbers');
       ...
       _this.framesChange1 = this.shuffle(_this.framesChange1);
        ...
        _this.SecondNumbers = this.add.sprite(_this.world.centerX+250,_this.world.centerY-143,'Unity12_3_1greenNumbers');
    ...
    {  
        ...
        //egg box
        _this.Eggbox= _this.add.sprite(_this.world.centerX-150,_this.world.centerY-10,'Unity12_3_1Egg_box');
        _this.Eggbox.anchor.setTo(0.5);
        _this.Eggbox.scale.setTo(1,1);
       
        
        _this.FirstNumbers1 = _this.add.sprite(_this.world.centerX-420,_this.world.centerY-173,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers1 = this.add.sprite(_this.world.centerX-370,_this.world.centerY-173,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign1=_this.add.sprite(_this.world.centerX-407,_this.world.centerY-195,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers2 = _this.add.sprite(_this.world.centerX-420,_this.world.centerY-135,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers2 = this.add.sprite(_this.world.centerX-370,_this.world.centerY-135,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign2=_this.add.sprite(_this.world.centerX-407,_this.world.centerY-155,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers3 = _this.add.sprite(_this.world.centerX-420,_this.world.centerY-95,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers3 = this.add.sprite(_this.world.centerX-370,_this.world.centerY-95,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign3=_this.add.sprite(_this.world.centerX-407,_this.world.centerY-115,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers4 = _this.add.sprite(_this.world.centerX-420,_this.world.centerY-60,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers4 = _this.add.sprite(_this.world.centerX-370,_this.world.centerY-60,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign4=_this.add.sprite(_this.world.centerX-407,_this.world.centerY-80,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers5 = _this.add.sprite(_this.world.centerX-420,_this.world.centerY-23,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers5 = this.add.sprite(_this.world.centerX-370,_this.world.centerY-23,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign5=_this.add.sprite(_this.world.centerX-407,_this.world.centerY-45,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers6= _this.add.sprite(_this.world.centerX-420,_this.world.centerY+15,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers6 = this.add.sprite(_this.world.centerX-370,_this.world.centerY+15,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign6=_this.add.sprite(_this.world.centerX-407,_this.world.centerY-5,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers7= _this.add.sprite(_this.world.centerX-420,_this.world.centerY+53,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers7 = this.add.sprite(_this.world.centerX-370,_this.world.centerY+53,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign7=_this.add.sprite(_this.world.centerX-407,_this.world.centerY+33,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers8= _this.add.sprite(_this.world.centerX-420,_this.world.centerY+93,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers8 = _this.add.sprite(_this.world.centerX-370,_this.world.centerY+93,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign8=_this.add.sprite(_this.world.centerX-407,_this.world.centerY+70,'Unity12_3_1Multiplicationsign');
        ...
        _this.FirstNumbers9= _this.add.sprite(_this.world.centerX-420,_this.world.centerY+130,'Unity12_3_1greenNumbers');
        ...
        _this.SecondNumbers9 = _this.add.sprite(_this.world.centerX-370,_this.world.centerY+130,'Unity12_3_1greenNumbers');
        ...
        _this.Multiplicationsign9=_this.add.sprite(_this.world.centerX-407,_this.world.centerY+110,'Unity12_3_1Multiplicationsign');
        ...
        _this.SmallEgg1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-180,'Unity12_3_1SmallEgg');
        ...
        // glow
        _this.SmallEgg1_Glow = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-180,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg1_Glow_two = _this.add.sprite(_this.world.centerX-300,_this.world.centerY-180,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg1_Glow_three = _this.add.sprite(_this.world.centerX-278,_this.world.centerY-180,'Unity12_3_1threeGlow');
       ...
       // _this.SmallEgg1_Glow_three.frame = 1;
        ...
        _this.SmallEgg1_Glow_four = _this.add.sprite(_this.world.centerX-262,_this.world.centerY-180,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg1_Glow_five = _this.add.sprite(_this.world.centerX-242,_this.world.centerY-180,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg2 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY-180,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg3 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY-180,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg4 =_this.add.sprite(_this.world.centerX-203,_this.world.centerY-180,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg5 =_this.add.sprite(_this.world.centerX-165,_this.world.centerY-180,'Unity12_3_1SmallEgg');
...
//        /*******************************************/
        ...
        _this.SmallEgg6 =_this.add.sprite(_this.world.centerX-318,_this.world.centerY-142,'Unity12_3_1SmallEgg');
        ...
        //glow
        _this.SmallEgg2_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-142,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg2_glow1_two = _this.add.sprite(_this.world.centerX-300,_this.world.centerY-142,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg2_glow1_three = _this.add.sprite(_this.world.centerX-278,_this.world.centerY-142,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg2_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY-142,'Unity12_3_1fourGlow');
       ...
       // _this.SmallEgg2_glow1_four.frame = 1;
        ...
        _this.SmallEgg2_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY-142,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg7 =_this.add.sprite(_this.world.centerX-280,_this.world.centerY-142,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg8 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY-142,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg9 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY-142,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg10 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY-142,'Unity12_3_1SmallEgg');
...
//        /*****************************************/
        ...
        _this.SmallEgg11 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-105,'Unity12_3_1SmallEgg');
        ...
        //glow
        _this.SmallEgg3_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-105,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg3_glow1_two = this.add.sprite(_this.world.centerX-300,_this.world.centerY-105,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg3_glow1_three = this.add.sprite(_this.world.centerX-278,_this.world.centerY-105,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg3_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY-105,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg3_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY-105,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg12 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY-105,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg13 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY-105,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg14 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY-105,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg15 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY-105,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg16 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-65,'Unity12_3_1SmallEgg');
        ...
        //glow
        _this.SmallEgg4_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-65,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg4_glow1_two = this.add.sprite(_this.world.centerX-300,_this.world.centerY-65,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg4_glow1_three = this.add.sprite(_this.world.centerX-278,_this.world.centerY-65,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg4_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY-65,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg4_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY-65,'Unity12_3_1fiveGlow');
...
//        _this.SmallEgg4_glow1_five.visible=false;
        ...
        _this.SmallEgg17 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY-65,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg18 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY-65,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg19 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY-65,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg20 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY-65,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg21 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-27,'Unity12_3_1SmallEgg');
        ...
        //glow
        _this.SmallEgg5_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY-27,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg5_glow1_two = this.add.sprite(_this.world.centerX-300,_this.world.centerY-27,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg5_glow1_three = this.add.sprite(_this.world.centerX-278,_this.world.centerY-27,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg5_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY-27,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg5_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY-27,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg22 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY-27,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg23 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY-27,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg24 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY-27,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg25 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY-27,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg26 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+12,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg26.name = "SmallEgg16";
         ...
         //glow
        _this.SmallEgg6_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+12,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg6_glow1_two = this.add.sprite(_this.world.centerX-300,_this.world.centerY+12,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg6_glow1_three = this.add.sprite(_this.world.centerX-278,_this.world.centerY+12,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg6_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY+12,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg6_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY+12,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg27 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY+12,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg28 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY+12,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg29 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY+12,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg30 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY+12,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg31 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+50,'Unity12_3_1SmallEgg');
        ...
        //glow
        _this.SmallEgg7_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+50,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg7_glow1_two = this.add.sprite(_this.world.centerX-300,_this.world.centerY+50,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg7_glow1_three = this.add.sprite(_this.world.centerX-278,_this.world.centerY+50,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg7_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY+50,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg7_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY+50,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg32 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY+50,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg33 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY+50,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg34 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY+50,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg35 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY+50,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg36 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+86,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg36.name = "SmallEgg22";
         ...
         //glow
        _this.SmallEgg8_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+86,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg8_glow1_two = this.add.sprite(_this.world.centerX-300,_this.world.centerY+86,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg8_glow1_three = this.add.sprite(_this.world.centerX-278,_this.world.centerY+86,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg8_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY+86,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg8_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY+86,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg37 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY+86,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg38 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY+86,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg39 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY+86,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg40 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY+86,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg41 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+124,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg41.name = "SmallEgg25";
         ...
         //glow
        _this.SmallEgg9_glow1 = _this.add.sprite(_this.world.centerX-318,_this.world.centerY+124,'Unity12_3_1oneGlow');
        ...
        _this.SmallEgg9_glow1_two = _this.add.sprite(_this.world.centerX-300,_this.world.centerY+124,'Unity12_3_1twoGlow');
        ...
        _this.SmallEgg9_glow1_three = _this.add.sprite(_this.world.centerX-278,_this.world.centerY+124,'Unity12_3_1threeGlow');
        ...
        _this.SmallEgg9_glow1_four= _this.add.sprite(_this.world.centerX-262,_this.world.centerY+124,'Unity12_3_1fourGlow');
        ...
        _this.SmallEgg9_glow1_five= _this.add.sprite(_this.world.centerX-242,_this.world.centerY+124,'Unity12_3_1fiveGlow');
        ...
        _this.SmallEgg42 = _this.add.sprite(_this.world.centerX-280,_this.world.centerY+124,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg43 = _this.add.sprite(_this.world.centerX-243,_this.world.centerY+124,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg44 = _this.add.sprite(_this.world.centerX-203,_this.world.centerY+124,'Unity12_3_1SmallEgg');
        ...
        _this.SmallEgg45 = _this.add.sprite(_this.world.centerX-165,_this.world.centerY+124,'Unity12_3_1SmallEgg');
        ...
        //drag egg
        _this.SmallEgg1_1 = _this.add.sprite(_this.world.centerX-325,_this.world.centerY+230,'Unity12_3_1SmallEgg');
        _this.SmallEgg1_1.anchor.setTo(0.5);
        _this.SmallEgg1_1.scale.setTo(1,1);
        _this.SmallEgg1_1.name = "SmallEgg1_1";
        
        _this.SmallEgg1_2 = _this.add.sprite(_this.world.centerX-300,_this.world.centerY+230,'Unity12_3_1SmallEgg');
        _this.SmallEgg1_2.anchor.setTo(0.5);
        _this.SmallEgg1_2.scale.setTo(1,1);
        _this.SmallEgg1_2.name = "SmallEgg1_2";
       
        _this.SmallEgg1_3 = _this.add.sprite(_this.world.centerX-275,_this.world.centerY+230,'Unity12_3_1SmallEgg');
        _this.SmallEgg1_3.anchor.setTo(0.5);
        _this.SmallEgg1_3.scale.setTo(1,1);
        _this.SmallEgg1_3.name = "SmallEgg1_3";
       
        _this.SmallEgg1_4 = _this.add.sprite(_this.world.centerX-250,_this.world.centerY+230,'Unity12_3_1SmallEgg');
        _this.SmallEgg1_4.anchor.setTo(0.5);
        _this.SmallEgg1_4.scale.setTo(1,1);
        _this.SmallEgg1_4.name = "SmallEgg1_4";
        
        _this.SmallEgg1_5 = _this.add.sprite(_this.world.centerX-223,_this.world.centerY+230,'Unity12_3_1SmallEgg');
    ...
    addNumberPad:function()
    {
        ...
        _this.Numberbox= _this.add.sprite(_this.world.centerX+270,_this.world.centerY+20,'Unity12_3_1Number_box');
        ...
        _this.Multiplicationsign=_this.add.sprite(_this.world.centerX+185,_this.world.centerY-175,'Unity12_3_1Multiplicationsign');
        _this.Multiplicationsign.name="Unity12_1Multiplicationsign";
        _this.Multiplicationsign.scale.setTo(1,1);
      
        _this.EqualSymbol = _this.add.sprite(_this.world.centerX+270,_this.world.centerY-175,'Unity12_3_1EqualSymbol');
        ...
        // numbers 0 to 9
        _this.calNum1=this.add.sprite(_this.world.centerX+180,_this.world.centerY-53,'Unity12_3_1Numbers');
        ...
        _this.calNum2=_this.add.sprite(_this.world.centerX+265,_this.world.centerY-53,'Unity12_3_1Numbers');
        ...
        _this.calNum3=_this.add.sprite(_this.world.centerX+345,_this.world.centerY-53,'Unity12_3_1Numbers');
        ...
        _this.calNum4=_this.add.sprite(_this.world.centerX+180,_this.world.centerY+30,'Unity12_3_1Numbers');
        ...
        _this.calNum5=_this.add.sprite(_this.world.centerX+265,_this.world.centerY+30,'Unity12_3_1Numbers');
        ...
        _this.calNum6=_this.add.sprite(_this.world.centerX+345,_this.world.centerY+30,'Unity12_3_1Numbers');
        ...
        _this.calNum7=_this.add.sprite(_this.world.centerX+180,_this.world.centerY+115,'Unity12_3_1Numbers');
        ...
        _this.calNum8=_this.add.sprite(_this.world.centerX+265,_this.world.centerY+115,'Unity12_3_1Numbers');
        ...
        _this.calNum9=_this.add.sprite(_this.world.centerX+345,_this.world.centerY+115,'Unity12_3_1Numbers');
        ...
        _this.calNum0=_this.add.sprite(_this.world.centerX+180,_this.world.centerY+200,'Unity12_3_1Numbers');
        ...
        _this.eraser=_this.add.sprite(_this.world.centerX+265,_this.world.centerY+205,'Unity12_3_1Eraser');
        ...
        _this.tick =_this.add.sprite(_this.world.centerX+345,_this.world.centerY+205,'Unity12_3_1Tick');
       ...
       // _this.Eggbox.visible = false;
        ...
        if(_this.no11<6)
        {
           // _this.timer1.stop();
            ...
            _this.NumberGrp1.destroy();
            _this.NumberGrp2.destroy();
            _this.NumberGrp3.destroy();
  ...
  if((this.scoreSceneScore/this.maxscore) < 0.4){
      ...
      replayClicked:function()
    {
        ...
        { 
            ...
            commonNavBar.hint3=true,
			this.backgroundtransp.visible=false;
            _this.state.start('multiplication_NOMG_2_1level1',true,false);
        }, this);
    },
  ...
  /*  getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 8: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/English/12.3.1.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Hindi/12.3.1.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Kannada/12.3.1.mp3");
                    }
                    else
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/12.3.1/Odiya/12.3.1.mp3");
    ...
    shutdown:function()
        {
            ...
            if(this.playedwithHint&&this.completelyplayed)
            {
                ...
                localStorage.setItem(window.avatarName+"multiplication_NOMG_2_1state", "playedwithhint");
                localStorage.setItem(window.avatarName+"numberoperationPlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                telInitializer2.syncToServer();
                localStorage.setItem(window.avatarName+"multiplication_NOMG_2_1state", "fullycomplete");
                localStorage.setItem(window.avatarName+"multiplication_NOMG_3_1state", "canplay");
                localStorage.setItem(window.avatarName+"numberoperationPlayed", "played");
            }   
        }
