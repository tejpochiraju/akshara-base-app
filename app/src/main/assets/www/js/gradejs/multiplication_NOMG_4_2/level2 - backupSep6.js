...
Game.multiplication_NOMG_4_2level2.prototype ={
    ...
    create:function(game)
    {
        ...
        {
            _this.soundurl =  window.baseUrl+"questionSounds/12.3.3/English/12.3.1.mp3";
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/12.3.3/Hindi/12.3.1.mp3";
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/12.3.3/Kannada/12.3.1.mp3";
        }
        else
        {
            _this.soundurl =  window.baseUrl+"questionSounds/12.3.3/Odiya/12.3.1.mp3";
