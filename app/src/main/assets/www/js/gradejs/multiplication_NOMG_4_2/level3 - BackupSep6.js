    ...
    shutdown:function()
        {
            ...
            {
                localStorage.setItem("multiplication_NOMG_4_2state", "playedwithhint");
                localStorage.setItem("numberoperationPlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                localStorage.setItem("multiplication_NOMG_4_2state", "fullycomplete");
                localStorage.setItem("multiplication_NOMG_5_3state", "canplay");
                localStorage.setItem("numberoperationPlayed", "played");
            }   
        }  
