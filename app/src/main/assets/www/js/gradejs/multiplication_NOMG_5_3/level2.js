Game.multiplication_NOMG_5_3level2=function(){};
var group2;
...
Game.multiplication_NOMG_5_3level2.prototype={
     init:function(param,score,timerStopVar)
    {
      ...
      //  _this.cmusic = _this.add.audio('celebr');
        ...
        if(window.languageSelected=="English")
                         _this.qsoundurl =window.baseUrl+"questionSounds/14.2/English/Game 14.2.mp3";
                    else if(window.languageSelected=="Hindi")
                        _this.qsoundurl =window.baseUrl+"questionSounds/14.2/Hindi/Game 14.2.mp3";
                    else if(window.languageSelected=="Kannada")
                        _this.qsoundurl =window.baseUrl+"questionSounds/14.2/Kannada/Game 14.2.mp3";
                    else if(window.languageSelected=="Gujarati")
                        _this.qsoundurl =window.baseUrl+"questionSounds/Gujarati/14.2/Game14.2.mp3";
                    else
                        _this.qsoundurl =window.baseUrl+"questionSounds/14.2/Odiya/14.2.mp3";
       ...
       // commonNavBar.addHint(this);
        this.hintparams=['NOMG5.3','level2',false,false,true,1];
  ...
  return array;
    ...
    gotoquestion2:function(){
        ...
        for(var b=0;b<=(_this.addyellowh+3);b++){
            _this.gridv = this.add.sprite(75,284,'Level14_gridv');
			//_this.gridv.scale.setTo(0.86,0.90);
			_this.gridv.scale.setTo(0.9,0.95);
            _this.gridv.name="vertical";
            _this.gridv.inputEnabled=true;
  ...
  if((this.scoreSceneScore/this.maxscore) < 0.4){
    ...
    replayClicked:function()
    {
        ...
        { 
            ...
            commonNavBar.hint3=true,
			this.backgroundtransp.visible=false;
            _this.state.start('multiplication_NOMG_5_3level1',true,false);
        }, this);
    },
     ...
     shutdown:function()
        {
            ...
            if(this.playedwithHint&&this.completelyplayed)
            {
                ...
                localStorage.setItem(window.avatarName+"multiplication_NOMG_5_3state", "playedwithhint");
                localStorage.setItem(window.avatarName+"numberoperationPlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                telInitializer2.syncToServer();
                localStorage.setItem(window.avatarName+"multiplication_NOMG_5_3state", "fullycomplete");
