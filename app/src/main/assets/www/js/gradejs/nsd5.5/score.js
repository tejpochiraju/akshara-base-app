Game.nsd5_5Score=function(game){

};

Game.nsd5_5Score.prototype={
	create:function(game){
		...
		if(_this.video5==null)
			{	
				_this.video5 = _this.add.video('demo7_1_1');
		...
		_this.nextBtn.events.onInputDown.add(function()
		{
			...
			document.getElementById('phaser_canvas').style.pointerEvents = "none";
					...
					_this.video5.play(false);
					
					_this.video5.changeSource(window.baseUrl+"assets/demoVideos/nsd6_5.mp4");

					
					_this.video5.addToWorld();
					//_this.video5.addToWorld(0,0,0,0,1.25,1.32);
					
					_this.video5.play(false);
					_this.video5.mute = true;
					_this.video5.playbackRate = 2;
					...
					_this.video5.onComplete.add(function(){
	...
	shutdown:function()
	{
		...
		/*if(_this.video5)
		{
			_this.video5.destroy();
			_this.video5.removeVideoElement();
			_this.video5 = null;
		}*/
	}
