   ...
   /* getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 4:
            case 5:
            case 6: commonNavBar.getVoice("questionSounds/2.3.1/English/2.3.mp3");
        }
    ...
    shutdown:function()
    {
        ...
        window.score += commonNavBar.deductForHint;
            ...
            if(this.playedwithHint&&this.completelyplayed)
            {
                ...
                localStorage.setItem(window.avatarName+"sequence_NSSG_1_1state", "playedwithhint");
                localStorage.setItem(window.avatarName+"numbersensePlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                telInitializer2.syncToServer();
                localStorage.setItem(window.avatarName+"sequence_NSSG_1_1state", "fullycomplete");
                localStorage.setItem(window.avatarName+"sequence_NSSG_2_1state", "canplay");
                localStorage.setItem(window.avatarName+"numbersensePlayed", "played");
            }   
