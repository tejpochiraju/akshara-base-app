Game.sequence_NSSG_5_3level2=function(){};


Game.sequence_NSSG_5_3level2.prototype ={
    ...
    init:function(param,score,timerStopVar)
    {
       ...
       // commonNavBar.addHint(this,);
         this.hintparams=['NSSG5.3','level2',false,false,true,1];
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_2_3_start', 20, false);
    ...
    gotoFourthQuestion:function()
    {
        ...
        _this.Neutral =_this.Caterpillar_head.animations.add('unity2_2_3_start');
        _this.Caterpillar_head.animations.play('unity2_2_3_tart', 20, false);
...
//                
    ...
    {  
        ...
        _this.Caterpillar_head.animations.play('unity2_2_3a_start', 30, false);
    ...
    removeEverthing1:function() 
    {
        ...
        else
        {
           ...
           // commonNavBar.stopTimer();
            ...
            //console.log("inside removeEverthing");
            _this.MaintweenDestroy.onComplete.add(function(){
            _this.state.start('sequence_NSSG_5_3level3',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
			},_this);  
        }
    },
  ...
  /*  getVoice:function()
    {
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 10: if(window.languageSelected=="English")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.2.3/English/2.2.mp3");
                    }
                    else if(window.languageSelected=="Hindi")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.2.3/Hindi/2.2.mp3");
                    }
                    else if(window.languageSelected=="Kannada")
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.2.3/Kannada/2.2.mp3");
                    }
					else
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.2.3/Odiya/2.2.3.mp3");
