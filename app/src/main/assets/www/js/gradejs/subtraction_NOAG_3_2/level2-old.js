Game.subtraction_NOAG_3_2level2=function(){};


Game.subtraction_NOAG_3_2level2.prototype={
	...
	create:function(game){
		...
		_this.physics.setBoundsToWorld();
             ...
             _this.bg1 = _this.add.tileSprite(0,0,_this.world.width,_this.world.height, 'Level321_bg1');
              if(window.languageSelected == "English")
                {
                   _this.soundurl =  window.baseUrl+"questionSounds/3.2.1/English/Game 10.2.2.mp3";
                }
                else if(window.languageSelected == "Hindi")
                {
                    _this.soundurl =  window.baseUrl+"questionSounds/3.2.1/Hindi/Game 10.2.2.mp3";
                }
                else if(window.languageSelected=="Kannada")
                {
                    _this.soundurl =  window.baseUrl+"questionSounds/3.2.1/Kannada/Game 10.2.2.mp3";
                }
                ...
                {
                    _this.soundurl =  window.baseUrl+"questionSounds/3.2.1/Odiya/10.2.2.mp3";
             ...
             this.hintparams=['NOSG32','level2',false,false,true,1];
       ...
       // _this.numBoxNum2.visible = false;
        ...
        /*if(window.languageSelected == "English")
            {
              commonNavBar.getVoice( window.baseUrl+"questionSounds/3.2.1/English/Game 10.2.2.mp3");
            }
            else if(window.languageSelected == "Hindi")
            {
              commonNavBar.getVoice( window.baseUrl+"questionSounds/3.2.1/Hindi/Game 10.2.2.mp3");
            }
            else if(window.languageSelected=="Kannada")
            {
                commonNavBar.getVoice( window.baseUrl+"questionSounds/3.2.1/Kannada/Game 10.2.2.mp3");
            }
            else
            {
                commonNavBar.getVoice( window.baseUrl+"questionSounds/3.2.1/Odiya/10.2.2.mp3");
                _this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
            }*/
    },
    ...
    replayClicked:function()
    {
        ...
        { 
           ...
           //_this.state.start('level2',true,false,this.qarray,this.score);
            ...
            commonNavBar.hint3=true,
			this.backgroundtransp.visible=false; //Remove BackGround Opacity
           _this.state.start('subtraction_NOAG_3_2level1',true,false);
        }, this);
    },
      ...
      shutdown:function()
        {
            ...
            if(this.playedwithHint&&this.completelyplayed)
            {
                ...
                localStorage.setItem(window.avatarName+"subtraction_NOSG_3_2state", "playedwithhint");
                localStorage.setItem(window.avatarName+"numberoperationPlayed", "played");
            }
            else if(!this.playedwithHint&&this.completelyplayed)
            {
                telInitializer2.syncToServer();
                localStorage.setItem(window.avatarName+"subtraction_NOSG_3_2state", "fullycomplete");
