Game.time_MTG_1_1level4=function(){};
...
Game.time_MTG_1_1level4.prototype={
    ...
    create:function(game){
        ...
        { 
            _this.soundurl =  window.baseUrl+"questionSounds/5.4/English/5.4_1.mp3";
        }
        else if(window.languageSelected == "Hindi")
        {
             _this.soundurl =  window.baseUrl+"questionSounds/5.4/Hindi/5.4_1.mp3";
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/5.4/Kannada/5.4_1.mp3";
        }
        ...
        this.hintparams=['MTG1.1','level4',false,false,false,0];
...
//        },_this);
    ...
    slide1:function()
    {
         _this.rightmark = this.add.sprite(850,240,'Level51A_tickMark');
    ...
    slide2:function(){
         ...
         _this.rightmark = this.add.sprite(900,240,'Level51A_tickMark');
        _this.rightmark.inputEnabled=false;
		_this.rightmark.visible = false;
                ...
                else
                {
                   ...
                   // _this.wrongAns(target);
                    ...
                    if(target.value=="slide1")
                    {
                       ...
                       // groupmonth[displmonth[0]].inputEnabled=false;
                       // groupmonth[displmonth[1]].inputEnabled=false;
                        //groupmonth[displmonth[2]].inputEnabled=false;
                    }
                    else
                    { 
                        console.log("HEEEEEE");
                     if(group2.getChildAt(h).visible != false)
                     {
                        ...
                        groupmonth[displmonth[1]].inputEnabled=false;
                        groupmonth[displmonth[2]].inputEnabled=false;
                        groupmonth[displmonth[3]].inputEnabled=false;
                        groupmonth[displmonth[4]].inputEnabled=false;
                        groupmonth[displmonth[5]].inputEnabled=false;
                        groupmonth[displmonth[6]].inputEnabled=false;
                        groupmonth[displmonth[7]].inputEnabled=false;
                        groupmonth[displmonth[8]].inputEnabled=false;
                        groupmonth[displmonth[9]].inputEnabled=false;
                        groupmonth[displmonth[10]].inputEnabled=false;
                        groupmonth[displmonth[11]].inputEnabled=false;*/
                    }
    ...
    getVoice:function(slideno){
        ...
        if(window.languageSelected == "English")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/5.4/English/5.4_1.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/5.4/Hindi/5.4_1.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/5.4/Kannada/5.4_1.mp3");
        }
        else
        {
