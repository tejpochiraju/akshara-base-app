...
//     }, this);                
    ...
    checkAns:function(target,group,len,extraparam)
    {
        ...
        case "SelectMonth":if(target.name == "january"||target.name == "march"||target.name == "april"||target.name == "may"||target.name == "june"||target.name == "july"||target.name =="august"||target.name == "october")
                                {
        ...
        _this.src = document.createElement('source');
         switch(voices[0])
         {
            ...
            case "firstWednesday":if(window.languageSelected == "English")
                            ...
                            {
                                _this.src.setAttribute("src", window.baseUrl+window.baseUrl+"questionSounds/6.1/OfirstWednesday.mp3");
                                _this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                            }
                            break;
