Game.time_MTG_2_3level1=function(){};
var no22;
var no11;
var qArrays;
var circleanim00;
   ...
   create:function(game){
    ...
    qArrays = new Array();
      ...
      // _this.speakerbtn.inputEnabled = true;
        ...
        /* _this.timebg=this.add.sprite(305,8,'Level42B_timer');
...
addQuestion:function(no22)
{
    ...
    gotoFirstQuestion:function(){
        ...
        months = this.add.sprite(0,0,'Level61_months');
 ...
 gotoThirdQuestion:function(){
    _this.questionid = 1;
      ...
      months.events.onInputDown.add(function(){
        ...
        year = this.add.sprite(505,125,'Level61_year');
        year.scale.setTo(1,1);
        year.value="111";
        year.inputEnabled=true;
        year.input.useHandCursor = true;
...
gotoEighthQuestion:function(){
        ...
        else 
        {
           ...
           this.time.events.add(1000,function(){
            ...
            commonNavBar.speakerbtn = null;
                               // this.state.start('grade6_1Score');
                               this.state.start('time_MTG_2_3level2',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
                           },this); 
       }
   ...
   {
    flagGroup1.setAll("inputEnabled",false);
    ...
    countboth++;
                    ...
                    case "SelectMonth":
                        if(target.name == "january"||target.name == "march"||target.name == "april"||target.name == "may"||target.name == "june"||target.name == "july"||target.name =="august"||target.name == "october")
                        {
                            circleanim101.alpha=1;
                            if(window.languageSelected=="English"){
                                circleanim101.scale.setTo(0.76,1);
                                circleanim101.x=target.x+17;//-20;
                                circleanim101.y=target.y+5;
                            }
                            else if(window.languageSelected=="Hindi"){
                                circleanim101.scale.setTo(0.70,1);
                                circleanim101.x=target.x+16;
                                circleanim101.y=target.y+6;
                            }else if(window.languageSelected=="Kannada"){
                                if(target.name == "may"){
                                    circleanim101.scale.setTo(0.70,1);
                                }else{
                                    circleanim101.scale.setTo(0.75,1);
                                }
                                circleanim101.x=target.x+17;
                                circleanim101.y=target.y+9;
                            }else{
                                circleanim101.scale.setTo(0.58,1);
                                circleanim101.x=target.x+17;
                                circleanim101.y=target.y+6;
                            }
                        ...
                        else if(target.name == "february" || target.name == "september" || target.name == "november"||target.name == "december" ){
                            circleanim101.alpha=1;
                            if(window.languageSelected=="English"){
                                circleanim101.scale.setTo(0.95,1);
                                circleanim101.x=target.x+8;
                                circleanim101.y=target.y+4;
                            }  
                            else if(window.languageSelected=="Hindi"){
                                circleanim101.scale.setTo(0.75,1);
                                circleanim101.x=target.x+15;
                                circleanim101.y=target.y+6;
                                ...
                                circleanim101.scale.setTo(0.67,1);
                                circleanim101.x=target.x+15;
                                circleanim101.y=target.y+6;
                            }
                            circleanim101.smoothed = true;
    ...
    getVoice:function(){
       ...
       //console.log("getVoice "+qArrays[no11]);
                                ...
                                switch(voices[0])
                                {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EMonday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HMonday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KMonday.mp3");
                                    }
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ETuesday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HTuesday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KTuesday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EWednesday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HWednesday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KWednesday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EThursday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HThursday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KThursday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EFriday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HFriday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KFriday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ESunday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HSunday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KSunday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EfirstDay.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HfirstDay.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KfirstDay.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ElastDay.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HlastDay.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KlastDay.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EfirstMonday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HfirstMonday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KfirstMonday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EfirstTuesday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HfirstTuesday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KfirstTuesday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EfirstWednesday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HfirstWednesday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KfirstWednesday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ElastSunday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HlastSunday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KlastSunday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ElastSaturday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HlastSaturday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KlastSaturday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ElastFriday.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HlastFriday.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KlastFriday.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/Efirst2Days.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/Hfirst2Days.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/Kfirst2Days.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/Elast2Days.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/Hlast2Days.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/Klast2Days.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/ESelectMonth.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HSelectMonth.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KSelectMonth.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                    ...
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/EselectYear.mp3");
                                    }
                                    else if(window.languageSelected == "Hindi")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/HselectYear.mp3");
                                    }
                                    else if(window.languageSelected == "Kannada")
                                    {
                                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/6.1/KselectYear.mp3");
                                    }
                                    else if(window.languageSelected == "Gujarati")
                                    {
                                ...
                                commonNavBar.addNavBar(_this,_this.src.src,"measurement3");
                            },
