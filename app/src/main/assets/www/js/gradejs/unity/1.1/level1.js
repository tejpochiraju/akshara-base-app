...
Game.unity1_1level1.prototype ={
    ...
    preload:function(game){
        if(!window.grade1NSN1){

            window.grade1NSN1 = true;
	...
	create:function(game)
    {
        ...
        _this.speakerbtn = _this.add.sprite(600,6,'unity1_1CommonSpeakerBtn');
        ...
        _this.timebg = this.add.sprite(305,6,'unity1_1timebg');
...
//            _this.candyAnim1.play(10,true);
    ...
    {    
        ...
        _this.backgrd1.input.priorityID = 2;
        ...
        _this.backgrd2.input.priorityID = 2;
        ...
        _this.backgrd3.input.priorityID = 2;
