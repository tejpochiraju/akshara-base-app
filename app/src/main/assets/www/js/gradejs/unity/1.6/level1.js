...
Game.unity1_6level1.prototype={
    ...
    preload:function(game){
        if(!window.grade1NSN6){

            window.grade1NSN6 = true;
	...
	create:function(game){
       ...
       // _this.baudio.play();
        ...
        _this.timebg = _this.add.sprite(305,6,'unity16_timebg');
       ...
       _this.speakerbtn = _this.add.sprite(600,6,'unity16_CommonSpeakerBtn');
...
numClicked:function(target){
    ...
    generateStarsForTheScene:function(count)
	{
		...
		{
			_this.starsGroup.create(_this.world.centerX-15, 10, 'unity16_starAnim');
			for(var j =0;j<i;j++)
			{
