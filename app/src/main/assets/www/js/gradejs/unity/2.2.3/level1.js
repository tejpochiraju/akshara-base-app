...
Game.unity2_2_3level1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.speakerbtn = _this.add.sprite(600,6,'unity2_2_3_CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(305,6,'unity2_2_3_timebg');
       ...
       /* _this.playQuestionSound = document.createElement('audio');
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/2.2.1/Odiya/2.2.3.mp3");
        }
