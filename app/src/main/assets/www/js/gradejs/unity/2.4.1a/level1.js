...
Game.unity2_4_1alevel1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.speakerbtn = _this.add.sprite(600,6,'Unity2_4_1CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(305,6,'Unity2_4_1timebg');
    ...
    {  
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_4_1a_start', 20, true);
            },this);
        }
        else
        {
