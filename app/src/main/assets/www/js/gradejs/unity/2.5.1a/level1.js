...
Game.unity2_5_1alevel1.prototype ={
	...
	create:function(game)
    {
        ...
        _this.speakerbtn = _this.add.sprite(600,6,'Unity2_5_1CommonSpeakerBtn');
        ...
        _this.timebg = _this.add.sprite(305,6,'Unity2_5_1timebg');
       ...
       // _this.CaterpillarWhiteCopy.add(_this.Caterpillar_body_head_2Copy);
        ...
        if(_this.wrong)
        {
            ...
            _this.tween.onComplete.add(function()
            {
                ...
                _this.Caterpillar_head.animations.play('Unity2_5_1astart', 20, true);
