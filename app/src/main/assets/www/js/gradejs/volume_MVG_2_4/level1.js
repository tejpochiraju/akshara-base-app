Game.volume_MVG_2_4level1=function(){};
...
var AnsTimerCount;
var gameid;
Game.volume_MVG_2_4level1.prototype={
    init:function(param,score)
    {
        ...
        telInitializer2.gameIdInit2("MVG2.4");
    },

    preload:function(game){
        if(!window.grade4MVG2){

            window.grade4MVG2 = true;
    ...
    if(!window.grade4MVG3){

            window.grade4MVG3 = true;
    ...
    if(!window.grade4MVG4){

            window.grade4MVG4 = true;
    ...
    create:function(game){
        ...
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2A/English/4.2A1.mp3";
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2A/Hindi/4.2A1.mp3";
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2A/Kannada/4.2A1.mp3";
        }
		else if(window.languageSelected == "Gujarati")
		{
			 _this.soundurl = window.baseUrl+"questionSounds/Gujarati/4.2A/4.2A1.mp3";
		}
        else
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2A/Odiya/4.2A1.mp3";
        ...
        this.hintparams=['MVG2.4','level1',false,false,false,0];
    ...
    triggerevent:function(target){
        if(target.name=="pot")
        {
            ...
            else
            {
                if(syntexincr==6)
                {
                    ...
                    commonNavBar.playWaterSplashSound();
        ...
        if(target.name=="jug")
        {
            ...
            else
            {
                if(bucketincr==8)
                {
                    //                    commonNavBar.stopWaterFillingSound();
                    _this.waterFillingSound.pause();
                    commonNavBar.playWaterSplashSound();
...
//            commonNavBar.stopVoice();
        ...
        else
        {
            ...
            _this.state.start('volume_MVG_2_4level2',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
        }
    },
    ...
    getVoice:function(){
        ...
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.2A/Odiya/4.2A1.mp3");
            _this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
        }
