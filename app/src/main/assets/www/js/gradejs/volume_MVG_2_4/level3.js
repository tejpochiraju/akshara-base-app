Game.volume_MVG_2_4level3=function(){};
...
var leftmost;
var AnimOpt1;
Game.volume_MVG_2_4level3.prototype={
    ...
    create:function(game){
        ...
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2C/English/4.2C1.mp3";
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2C/Hindi/4.2C1.mp3";
        }
        else if(window.languageSelected=="Kannada")
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2C/Kannada/4.2C1.mp3";
        }
		else if(window.languageSelected == "Gujarati")
		{
			 _this.soundurl = window.baseUrl+"questionSounds/Gujarati/4.2A/4.2C1.mp3";
		}
        else
        {
            _this.soundurl =  window.baseUrl+"questionSounds/4.2C/Odiya/4.2C1.mp3";
...
//        _this.speakerbtn.input.useHandCursor = true;
    ...
    question1:function()
    {
        ...
        maskbg = this.add.sprite(-20,40,'Level42C_maskbg');
        maskbg.height-=40;
    ...
    replayClicked:function()
    {
        ...
        { 
            ...
            commonNavBar.speakerbtn=null;
			this.backgroundtransp.visible=false; //Remove BackGround Opacity
            _this.state.start('volume_MVG_2_4level1',true,false);
        }, this);
    },
...
//                        maskbg.height-=120;
    ...
    {   
        ...
        if(window.languageSelected == "English")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.2C/English/4.2C1.mp3");
        }
        else if(window.languageSelected == "Hindi")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.2C/Hindi/4.2C1.mp3");
        }
        else if(window.languageSelected == "Kannada")
        {
            _this.src.setAttribute("src", window.baseUrl+"questionSounds/4.2C/Kannada/4.2C1.mp3");
        } 
        else
        {
...
//        count1++;
    ...
    shutdown:function()
    {
        ...
        if(this.playedwithHint&&this.completelyplayed)
        {
            ...
            localStorage.setItem(window.avatarName+"volume_MVG_2_4state", "playedwithhint");
            localStorage.setItem(window.avatarName+"measurementPlayed", "played");
        }
        else if(!this.playedwithHint&&this.completelyplayed)
        {
            telInitializer2.syncToServer();
            localStorage.setItem(window.avatarName+"volume_MVG_2_4state", "fullycomplete");
            localStorage.setItem(window.avatarName+"volume_MVG_3_4state", "canplay");
            localStorage.setItem(window.avatarName+"measurementPlayed", "played");
        }
    }
