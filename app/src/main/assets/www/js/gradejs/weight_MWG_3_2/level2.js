Game.weight_MWG_3_2level2=function(){
...
Game.weight_MWG_3_2level2.prototype={
  ...
  /*  stopAllVoice:function(){
       ...
       /* objGroup.destroy();
        ...
        else
        {
           ...
           // console.log("gameover");
            ...
            obj2Group.destroy();
            //this.stopAllVoice();
            this.state.start('weight_MWG_3_2level3',true,false,this.Stararr,commonNavBar.getScore(),timerStopVar);
        }
    },
    ...
    addNumberPad:function(){
        ...
        if(window.languageSelected=="English")
            kgTxt1 = this.add.text(x+90,505, "Kg");
    ...
    generateStarsForTheScene:function(count)
	{
        ...
        starsGroup.getChildAt(3).frame = 2;						
	},
    ...
    {   
        ...
        _this.src = document.createElement('source');
                   ...
                   if(window.languageSelected == "English")
                    {
                        //_this.src.setAttribute("src", window.baseUrl+"questionSounds/3.3A/English/3.3B_1.mp3");
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/3.3A/English/3.3B_1.mp3");
                        _this.soundurl = window.baseUrl+"questionSounds/3.3A/English/3.3B_1.mp3";
                    }
                    else if(window.languageSelected == "Hindi")
                    {
                        //_this.src.setAttribute("src", window.baseUrl+"questionSounds/3.3A/Hindi/3.3B_1.mp3");
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/3.3A/Hindi/3.3B_1.mp3");
                        _this.soundurl = window.baseUrl+"questionSounds/3.3A/Hindi/3.3B_1.mp3";
                    }
                    else if(window.languageSelected == "Kannada")
                    {
                        //_this.src.setAttribute("src", window.baseUrl+"questionSounds/3.3A/Kannada/3.3B_1.mp3");
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/3.3A/Kannada/3.3B_1.mp3");
                        _this.soundurl = window.baseUrl+"questionSounds/3.3A/Kannada/3.3B_1.mp3";
                    }
                    else if(window.languageSelected == "Gujarati")
                    {
                        //_this.src.setAttribute("src", window.baseUrl+"questionSounds/3.3A/Kannada/3.3A.mp3");
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/Gujarati/3.3A/3.3B_1.mp3");
                        _this.soundurl = window.baseUrl+"questionSounds/Gujarati/3.3A/3.3B_1.mp3";
                    }
					else
                    {
                        //_this.src.setAttribute("src", window.baseUrl+"questionSounds/3.3A/Odiya/3.3B_1.mp3");
                        commonNavBar.getVoice(window.baseUrl+"questionSounds/3.3A/Odiya/3.3B_1.mp3");
                        _this.soundurl = window.baseUrl+"questionSounds/3.3A/Odiya/3.3B_1.mp3";
