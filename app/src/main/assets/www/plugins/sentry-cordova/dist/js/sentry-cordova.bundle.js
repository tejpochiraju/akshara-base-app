...
var Scope = /** @class */ (function () {
     ...
     */
    Scope.prototype.notifyEventProcessors = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        _d.trys.push([3, 5, , 6]);
                        return [4 /*yield*/, processor(__assign({}, processedEvent))];
                    case 4:
...
var Hub = /** @class */ (function () {
    ...
    Hub.prototype.pushScope = function () {
        ...
        this.getStack().push({
            ...
            scope: scope.Scope.clone(parentScope),
        });
    };
    /**
     ...
     */
    Hub.prototype.captureException = function (exception) {
     ...
     */
    Hub.prototype.captureEvent = function (event) {
     ...
     */
    Hub.prototype.addBreadcrumb = function (breadcrumb) {
     ...
     */
    Hub.prototype.addEventProcessor = function (callback) {
        var top = this.getStackTop();
...
var global_2 = global$1.getDefaultHub;
...
exports.getDefaultHub = global$1.getDefaultHub;
...
var dist_3 = dist$1.getDefaultHub;
...
var dist_6 = dist$2._callOnClient;
...
function initAndBind(clientClass, options, defaultIntegrations) {
    ...
    if (dist$1.getDefaultHub().getClient()) {
        return;
    }
    ...
    dist$1.getDefaultHub().bindClient(client);
...
exports.BaseClient = base.BaseClient;
...
var dist_1$3 = dist$3.captureException;
var dist_2$3 = dist$3.captureMessage;
var dist_3$2 = dist$3.configureScope;
var dist_4$2 = dist$3.Hub;
var dist_5$1 = dist$3.Scope;
var dist_6$1 = dist$3.BaseClient;
var dist_7 = dist$3.DSN;
var dist_8 = dist$3.SentryError;
var dist_9 = dist$3.LogLevel;
var dist_10 = dist$3.initAndBind;
...
unwrapExports$$1(misc);
var misc_1 = misc.getGlobalObject;
var misc_2 = misc.uuid4;

var supports = createCommonjsModule$$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
var supports_5 = supports.supportsReferrerPolicy;
...
var Raven$2 = ((RavenJS || {}).default || RavenJS);

var is = createCommonjsModule$$1(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
/**
...
var BaseTransport = /** @class */ (function () {
    function BaseTransport(options) {
        this.options = options;
        this.url = this.composeUrl(new dist$3.DSN(options.dsn));
    }
    /**
     * @inheritDoc
     */
    BaseTransport.prototype.composeUrl = function (dsn) {
        var auth = {
            sentry_key: dsn.user,
            sentry_secret: '',
            sentry_version: '7',
        ...
        var path = dsn.path ? "/" + dsn.path : '';
        var endpoint = protocol + "//" + dsn.host + port + path + "/api/" + dsn.projectId + "/store/";
        // Auth is intentionally sent as part of query string (NOT as custom HTTP header)
        // to avoid preflight CORS requests
        return endpoint + "?" + object_5(auth);
    };
    /**
     * @inheritDoc
     */
    BaseTransport.prototype.send = function (_) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                throw new dist$3.SentryError('Transport Class has to implement `send` method');
            });
        });
    };
...
var FetchTransport = /** @class */ (function (_super) {
     ...
     * @inheritDoc
     */
    FetchTransport.prototype.send = function (event) {
        return __awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        defaultOptions = {
                            ...
                            // It doesn't. And it throw exception instead of ignoring this parameter...
                            // REF: https://github.com/getsentry/raven-js/issues/1233
                            referrerPolicy: (supports_5() ? 'origin' : ''),
                        };
...
var XHRTransport = /** @class */ (function (_super) {
     ...
     * @inheritDoc
     */
    XHRTransport.prototype.send = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
...
var BrowserBackend = /** @class */ (function () {
    ...
    BrowserBackend.prototype.install = function () {
        ...
        Raven$2.setBreadcrumbCallback(function (breadcrumb) {
            dist$2.addBreadcrumb(breadcrumb);
            return false;
        });
        Raven$2._sendProcessedPayload = dist$2.captureEvent;
        return true;
    };
    /**
     * @inheritDoc
    ...
    BrowserBackend.prototype.sendEvent = function (event) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (!this.options.dsn) {
                    throw new dist$3.SentryError('Cannot sendEvent without a valid DSN');
                }
                else {
                    dsn = new dist$3.DSN(this.options.dsn);
                }
...
var OnUnhandledRejection = /** @class */ (function () {
    ...
    OnUnhandledRejection.prototype.handler = function (event) {
        dist$2.captureException(event.reason);
    };
    /**
     * @inheritDoc
     */
    OnUnhandledRejection.prototype.install = function () {
        if (global$2.addEventListener) {
            global$2.addEventListener('unhandledrejection', this.handler.bind(this));
        }
    };
...
TraceKit$1.report = (function reportModuleWrapper() {
  ...
  function installGlobalHandler() {
    ...
    _oldOnerrorHandler = _window$4.onerror;
    _window$4.onerror = traceKitWindowOnError;
    _onErrorHandlerInstalled = true;
  }
  ...
  function uninstallGlobalHandler() {
    ...
    _window$4.onerror = _oldOnerrorHandler;
    _onErrorHandlerInstalled = false;
    _oldOnerrorHandler = undefined;
  }
...
var SDKInformation = /** @class */ (function () {
    ...
    SDKInformation.prototype.install = function () {
        var _this = this;
        dist$1.getDefaultHub().addEventProcessor(function (event) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
function init(options) {
    dist$3.initAndBind(BrowserClient, options, defaultIntegrations);
}
...
exports.getDefaultHub = dist$1.getDefaultHub;
exports.Hub = dist$1.Hub;
exports.Scope = dist$1.Scope;
exports.Integrations = index$2;
...
var dist_4$3 = dist_3$3.addBreadcrumb;
var dist_5$2 = dist_3$3.captureMessage;
var dist_6$2 = dist_3$3.captureException;
var dist_7$1 = dist_3$3.captureEvent;
var dist_8$1 = dist_3$3.configureScope;
var dist_9$1 = dist_3$3.getHubFromCarrier;
var dist_10$1 = dist_3$3.getDefaultHub;
var dist_11 = dist_3$3.Hub;
var dist_12 = dist_3$3.Scope;
var dist_13 = dist_3$3.Integrations;
var dist_14 = dist_3$3.Transports;
var dist_15 = dist_3$3.Severity;
var dist_16 = dist_3$3.Status;
var dist_17 = dist_3$3.BrowserBackend;
var dist_18 = dist_3$3.BrowserClient;
var dist_19 = dist_3$3.defaultIntegrations;
var dist_20 = dist_3$3.init;
var dist_21 = dist_3$3.SDK_NAME;
var dist_22 = dist_3$3.SDK_VERSION;
...
var CordovaBackend = /** @class */ (function () {
    ...
    function CordovaBackend(options) {
        if (options === void 0) { options = {}; }
        this.options = options;
        this.browserBackend = new dist_17(options);
    }
    /**
     * @inheritDoc
     */
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, { status: dist_2.Success }];
                    case 2:
                        e_1 = _a.sent();
...
var Release = /** @class */ (function () {
     ...
     * @inheritDoc
     */
    Release.prototype.install = function () {
        var _this = this;
        dist_3().addEventProcessor(function (event) { return __awaiter(_this, void 0, void 0, function () {
            var release;
            return __generator(this, function (_a) {
                ...
                release = window$1.SENTRY_RELEASE && window$1.SENTRY_RELEASE.id;
                if (release && !event.release) {
                    event.release = release;
                    event.extra = __assign({}, event.extra, { __sentry_release: release });
                }
...
var Cordova = /** @class */ (function () {
    ...
    Cordova.prototype.install = function () {
        dist_3().addEventProcessor(function (event) { return normalizeData(event); });
    };
    return Cordova;
}());
...
function init(options) {
    dist_10(CordovaClient, options, __spread(dist_19, [new Cordova(), new Release(), new SDKInformation()]));
}
function setRelease(release) {
    dist_5(function (scope) {
...
exports.Integrations = index$5;
exports.Severity = dist_1;
exports.addBreadcrumb = dist_4$1;
exports.captureMessage = dist_2$2;
exports.captureException = dist_1$2;
exports.captureEvent = dist_3$1;
exports.configureScope = dist_5;
exports.getDefaultHub = dist_3;
exports.getHubFromCarrier = dist_4;
exports.Hub = dist_2$1;
exports.Scope = dist_1$1;
