   ...
   /* @Override
    ...
    public void onDoneButtonClicked() {
        ...
        */
        ...
        if(selectedSchoolTypePosition == 1)
        {
        ...
        */
        ...
        bundle1.putString("Select_language_value",""+DataParserUtil.getLanguageValueFromPosition(selectedLanguagePosition));
        mFirebaseAnalytics.logEvent("Select_language",bundle1);
        mFirebaseAnalytics.setUserProperty("User_language",""+DataParserUtil.getLanguageValueFromPosition(selectedLanguagePosition));
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        switch (adapterView.getId()) {
            ...
            case R.id.language_edit_spinner:
               String languageToLoad = DataParserUtil.getLocaleCodeFromLanguageValue(DataParserUtil.getLanguageValueFromPosition(i));
