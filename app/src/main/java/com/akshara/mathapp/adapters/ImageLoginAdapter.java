...
import com.akshara.mathapp.activity.ImageLoginActivity;
...
public class ImageLoginAdapter extends RecyclerView.Adapter<ImageLoginAdapter.ImageLoginViewHolder> {
    ...
    private void setLocalPathsForImage(final User user) {
        if (user.getName().equals(AppConstants.FISH_AVATAR_NAME))
            user.setAvatarPicLocalPath(AppConstants.FISH_AVATAR_URL);
        else if (user.getName().equals(AppConstants.BUTTERFLY_AVATAR_NAME))
            user.setAvatarPicLocalPath(AppConstants.BUTTERFLY_AVATAR_URL);
        else if (user.getName().equals(AppConstants.FLOWER_AVATAR_NAME))
            user.setAvatarPicLocalPath(AppConstants.FLOWER_AVATAR_URL);
        else if (user.getName().equals(AppConstants.PARROT_AVATAR_NAME))
            user.setAvatarPicLocalPath(AppConstants.PARROT_AVATAR_URL);
        else if (user.getName().equals(AppConstants.SUN_AVATAR_NAME))
            user.setAvatarPicLocalPath(AppConstants.SUN_AVATAR_URL);
        else if (user.getName().equals(AppConstants.TREE_AVATAR_NAME))
            user.setAvatarPicLocalPath(AppConstants.TREE_AVATAR_URL);
