...
public class User implements Parcelable {
    ...
    public String getGeoForFireBase() {
        return geoForFireBase;
    }
    ...
    public void setGeoForFireBase(String geo) {
        this.geoForFireBase = geo;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeString(geoForFireBase);
