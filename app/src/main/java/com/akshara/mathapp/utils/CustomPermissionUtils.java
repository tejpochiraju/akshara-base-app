    ...
    public static void onRequestPermissionsResult(Context mContext, int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            ...
            case AppConstants.REQUEST_LOCATION_PERMISSION:
                PermissionUtils.onRequestPermissionsResult(mContext, requestCode, permissions, grantResults, mContext.getString(R.string.message_rationale_location_permission));
                break;
        }
    }
}
